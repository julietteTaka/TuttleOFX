...
template <typename Scalar> struct MathOperatorProcessParams {
...
public:
  MathOperatorProcessParams<Scalar>
...
private:
  ...
  EMathOperatorType getMathOperatorType() const {
    return static_cast<EMathOperatorType>(_mathOperatorType->getValue());
  }
