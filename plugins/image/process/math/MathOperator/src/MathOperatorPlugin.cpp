...
MathOperatorPlugin::getProcessParams(const OfxPointD &renderScale) const {
  ...
  case eMathOperatorTypeRgba:
    ...
    case eMathOperatorOperatorPow:
      params.iRMathOperator = params.iGMathOperator = params.iBMathOperator =
...
void MathOperatorPlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
// bool MathOperatorPlugin::getRegionOfDefinition( const
...
//}
//
// void MathOperatorPlugin::getRegionsOfInterest( const
...
bool MathOperatorPlugin::isIdentity(const OFX::RenderArguments &args,
