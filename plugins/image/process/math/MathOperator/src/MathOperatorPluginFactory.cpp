 ...
 */
void
MathOperatorPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *mathOperatorOp =
      desc.defineChoiceParam(kMathOperatorOperator);
  ...
  OFX::ChoiceParamDescriptor *mathOperatorType =
      desc.defineChoiceParam(kMathOperatorType);
  ...
  OFX::DoubleParamDescriptor *masterValue =
      desc.defineDoubleParam(kMasterValue);
  ...
  OFX::BooleanParamDescriptor *redChannel =
      desc.defineBooleanParam(kRedChannel);
  redChannel->setLabel("Red");
  redChannel->setDefault(true);

  OFX::BooleanParamDescriptor *greenChannel =
      desc.defineBooleanParam(kGreenChannel);
  greenChannel->setLabel("Green");
  greenChannel->setDefault(true);

  OFX::BooleanParamDescriptor *blueChannel =
      desc.defineBooleanParam(kBlueChannel);
  blueChannel->setLabel("Blue");
  blueChannel->setDefault(true);

  OFX::BooleanParamDescriptor *alphaChannel =
      desc.defineBooleanParam(kAlphaChannel);
 ...
 */
OFX::ImageEffect *
MathOperatorPluginFactory::createInstance(OfxImageEffectHandle handle,
                                          OFX::EContext context) {
