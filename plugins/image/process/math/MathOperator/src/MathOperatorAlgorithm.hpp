...
template <class View>
void MathOperatorProcess<View>::processImagePlus(
    OfxRectI &procWindowOutput, const OfxRectI &procWindowRoW,
...
template <class View>
void MathOperatorProcess<View>::processImageMultiply(
    OfxRectI &procWindowOutput, const OfxRectI &procWindowRoW,
    const boost::gil::rgba32f_pixel_t &values,
    const boost::gil::rgba8_pixel_t &processChannel) {
  const OfxPointI procWindowSize = { procWindowRoW.x2 - procWindowRoW.x1,
...
template <class View>
void MathOperatorProcess<View>::processImagePow(
    OfxRectI &procWindowOutput, const OfxRectI &procWindowRoW,
    const boost::gil::rgba32f_pixel_t &values,
    const boost::gil::rgba8_pixel_t &processChannel) {
  const OfxPointI procWindowSize = { procWindowRoW.x2 - procWindowRoW.x1,
...
template <class View>
void MathOperatorProcess<View>::processImageSqrt(
    OfxRectI &procWindowOutput, const OfxRectI &procWindowRoW,
    const boost::gil::rgba32f_pixel_t &values,
    const boost::gil::rgba8_pixel_t &processChannel) {
  const OfxPointI procWindowSize = { procWindowRoW.x2 - procWindowRoW.x1,
...
template <class View>
void MathOperatorProcess<View>::processImageLn(
    OfxRectI &procWindowOutput, const OfxRectI &procWindowRoW,
    const boost::gil::rgba32f_pixel_t &values,
    const boost::gil::rgba8_pixel_t &processChannel) {
  const OfxPointI procWindowSize = { procWindowRoW.x2 - procWindowRoW.x1,
...
template <class View>
void MathOperatorProcess<View>::processImageLog(
    OfxRectI &procWindowOutput, const OfxRectI &procWindowRoW,
    const boost::gil::rgba32f_pixel_t &values,
    const boost::gil::rgba8_pixel_t &processChannel) {
  const OfxPointI procWindowSize = { procWindowRoW.x2 - procWindowRoW.x1,
