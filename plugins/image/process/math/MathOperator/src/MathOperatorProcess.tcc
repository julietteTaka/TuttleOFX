 ...
 */
template <class View>
void MathOperatorProcess<View>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput;

  MathOperatorProcessParams<MathOperatorPlugin::Scalar> params =
      _plugin.getProcessParams();
  ...
  case eMathOperatorOperatorPlus:
    processImagePlus(procWindowOutput, procWindowRoW, valuesPix,
                     processChannel);
    break;
  case eMathOperatorOperatorMultiply:
    processImageMultiply(procWindowOutput, procWindowRoW, valuesPix,
                         processChannel);
    break;
  ...
  case eMathOperatorOperatorSqrt:
    processImageSqrt(procWindowOutput, procWindowRoW, valuesPix,
                     processChannel);
    break;
