...
void BlurPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setDescription(
      "A Gaussian blur is the result of blurring an image by a Gaussian "
      "function."
      "\n"
      "\n"
      "It is a widely used effect in graphics software, typically to reduce "
      "image "
      "noise and reduce detail. The visual effect of this blurring technique "
      "is a "
      ...
      "Gaussian smoothing is also used as a pre-processing stage in computer "
      "vision "
