...
void ConvolutionPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setDescription(
      "A convolution is defined as the integral of the product of the two "
      "functions"
      "after one is reversed and shifted."
      "\n"
      "\n"
      "In mathematics and, in particular, functional analysis, convolution is a"
      "mathematical operation on two functions f and g, producing a third "
      "function"
      "that is typically viewed as a modified version of one of the original "
      "functions. "
      "Convolution is similar to cross-correlation. It has applications that "
      "include"
      ...
      "Euclidean"
      "space. In particular, the circular convolution can be defined for "
      "periodic"
      "functions (that is, functions on the circle), and the discrete "
      "convolution"
      "can be defined for functions on the set of integers. These "
      "generalizations of"
 ...
 */
void
ConvolutionPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
 ...
 */
OFX::ImageEffect *
ConvolutionPluginFactory::createInstance(OfxImageEffectHandle handle,
                                         OFX::EContext context) {
