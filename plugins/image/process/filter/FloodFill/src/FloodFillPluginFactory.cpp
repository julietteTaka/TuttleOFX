...
void FloodFillPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleFloodFill", "FloodFill", "FloodFill");
...
void FloodFillPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::DoubleParamDescriptor *upperThres =
      desc.defineDoubleParam(kParamUpperThres);
  ...
  OFX::DoubleParamDescriptor *lowerThres =
      desc.defineDoubleParam(kParamLowerThres);
  ...
  OFX::BooleanParamDescriptor *minmax =
      desc.defineBooleanParam(kParamMinMaxRelative);
 ...
 */
OFX::ImageEffect *
FloodFillPluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
