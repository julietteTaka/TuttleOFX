...
LocalMaximaProcessParams<LocalMaximaPlugin::Scalar>
LocalMaximaPlugin::getProcessParams(const OfxPointD &renderScale) const {
...
void LocalMaximaPlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
void LocalMaximaPlugin::getClipPreferences(
...
bool LocalMaximaPlugin::getRegionOfDefinition(
...
void LocalMaximaPlugin::getRegionsOfInterest(
...
void LocalMaximaPlugin::render(const OFX::RenderArguments &args) {
  ...
  //		{
  //			doGilRender2<LocalMaximaProcess, false,
  //boost::gil::rgba_layout_t>( *this, args, sBitDepth, false, dComponent,
  //dBitDepth );
  //			return;
  //		}
  ...
  //		{
  ////			doGilRender2<LocalMaximaProcess, false,
  ///boost::gil::rgb_layout_t>( *this, args, sBitDepth, false, dComponent,
  ///dBitDepth );
  //			return;
  //		}
  ...
  //mapPixelComponentEnumToString(sComponent) + ") not supported by the plugin."
  //);
  //		}
  //	}
...
switch( components )
  {
          case OFX::ePixelComponentRGBA:
          {
                  doGilRender<LocalMaximaProcess, false,
boost::gil::rgba_layout_t>( *this, args, bitDepth );
                  return;
          }
          case OFX::ePixelComponentRGB:
          {
                  doGilRender<LocalMaximaProcess, false,
boost::gil::rgb_layout_t>( *this, args, bitDepth );
                  return;
          }
          case OFX::ePixelComponentAlpha:
          case OFX::ePixelComponentCustom:
          case OFX::ePixelComponentNone:
          {
                  BOOST_THROW_EXCEPTION( exception::Unsupported()
                          << exception::user() + "Pixel components (" +
mapPixelComponentEnumToString(components) + ") not supported by the plugin." );
          }
  }
  BOOST_THROW_EXCEPTION( exception::Unknown() );
*/
