...
void LocalMaximaPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleLocalMaxima", "LocalMaxima", "LocalMaxima");
 ...
 */
void
LocalMaximaPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
 ...
 */
OFX::ImageEffect *
LocalMaximaPluginFactory::createInstance(OfxImageEffectHandle handle,
                                         OFX::EContext context) {
