...
void TimeShiftPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleTimeShift", "TimeShift", "TimeShift");
...
void TimeShiftPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  case OFX::eContextRetimer: {
    OFX::DoubleParamDescriptor *retimerParam =
        desc.defineDoubleParam(kOfxImageEffectRetimerParamName);
 ...
 */
OFX::ImageEffect *
TimeShiftPluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
