...
TimeShiftProcessParams<TimeShiftPlugin::Scalar>
TimeShiftPlugin::getProcessParams() const {
...
void TimeShiftPlugin::getFramesNeeded(const OFX::FramesNeededArguments &args,
...
bool TimeShiftPlugin::isIdentity(const OFX::RenderArguments &args,
