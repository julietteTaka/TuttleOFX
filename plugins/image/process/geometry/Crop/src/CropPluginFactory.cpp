...
void CropPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setOverlayInteractDescriptor(
      new OFX::DefaultEffectOverlayWrap<CropEffectOverlay>());
}
...
void CropPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *symmetric =
      desc.defineChoiceParam(kParamSymmetric);
  ...
  OFX::BooleanParamDescriptor *fixedRatio =
      desc.defineBooleanParam(kParamFixedRatio);
  ...
  OFX::GroupParamDescriptor *cropRegion =
      desc.defineGroupParam(kParamGroupCropRegion);
