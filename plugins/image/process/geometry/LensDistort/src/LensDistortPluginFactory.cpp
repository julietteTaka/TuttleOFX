...
void LensDistortPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setHostFrameThreading(
      false); // The plugin is able to manage threading per frame
  desc.setSupportsTiles(true);

  desc.setOverlayInteractDescriptor(
      new OFX::DefaultEffectOverlayWrap<LensDistortOverlayDescriptor>());
}
 ...
 */
void
LensDistortPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  // Controls
  OFX::BooleanParamDescriptor *displaySource =
      desc.defineBooleanParam(kParamDisplaySource);
  displaySource->setLabel("Display Source");
  displaySource->setDefault(false);
  displaySource->setHint("Display the image source (usefull to parameter the "
                         "distortion with lines overlays on the source "
                         "image).");
  ...
  coef2->setHint(
      "Secondary distortion coeffecient (usefull for fisheyes only)\n"
      ">0 : Barrel distortion\n"
      "<0 : Pincushion distortion\n");
  ...
  squeeze->setHint(
      "Squeeze distortion coeffecient (usefull for bad quality lens...)");

  OFX::Double2DParamDescriptor *asymmetric =
      desc.defineDouble2DParam(kParamAsymmetric);
  ...
  asymmetric->setHint(
      "asymmetric distortion coeffecient (usefull for bad quality lens...)");
  ...
  center->setHint(
      "Center parameter allows you to shift the center of distortion.");

  OFX::BooleanParamDescriptor *centerOverlay =
      desc.defineBooleanParam(kParamCenterOverlay);
  ...
  OFX::ChoiceParamDescriptor *centerType =
      desc.defineChoiceParam(kParamCenterType);
  ...
  preScale->setHint("If the transformation of optics is high, you may need to "
                    "change the scale of the result to be globally closer to "
                    "the source image or preserve a good resolution.");

  OFX::DoubleParamDescriptor *postScale =
      desc.defineDoubleParam(kParamPostScale);
  ...
  postScale->setHint("If the transformation of optics is high, you may need to "
                     "change the scale of the result to be globally closer to "
                     "the source image or preserve a good resolution.");
  ...
  OFX::ChoiceParamDescriptor *resizeRod =
      desc.defineChoiceParam(kParamResizeRod);
  ...
  OFX::DoubleParamDescriptor *scaleRod =
      desc.defineDoubleParam(kParamResizeRodManualScale);
  ...
  OFX::GroupParamDescriptor *displayOptions =
      desc.defineGroupParam(kParamDisplayOptions);
  displayOptions->setLabel("Display options");
  displayOptions->setHint("Display options (change nothing on the image)");

  OFX::BooleanParamDescriptor *displayGrid =
      desc.defineBooleanParam(kParamGridOverlay);
  ...
  OFX::Double2DParamDescriptor *gridCenter =
      desc.defineDouble2DParam(kParamGridCenter);
  ...
  OFX::BooleanParamDescriptor *gridCenterOverlay =
      desc.defineBooleanParam(kParamGridCenterOverlay);
  ...
  OFX::Double2DParamDescriptor *gridScale =
      desc.defineDouble2DParam(kParamGridScale);
  ...
  OFX::GroupParamDescriptor *debugOptions =
      desc.defineGroupParam(kParamDebugOptions);
  ...
  OFX::BooleanParamDescriptor *debugDisplayRoi =
      desc.defineBooleanParam(kParamDebugDisplayRoi);
 ...
 */
OFX::ImageEffect *
LensDistortPluginFactory::createInstance(OfxImageEffectHandle handle,
                                         OFX::EContext context) {
