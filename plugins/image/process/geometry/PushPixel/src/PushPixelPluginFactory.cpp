...
void PushPixelPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttlePushPixel", "PushPixel",
...
void PushPixelPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::DoubleParamDescriptor *intensity =
      desc.defineDoubleParam(kParamIntensity);
 ...
 */
OFX::ImageEffect *
PushPixelPluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
