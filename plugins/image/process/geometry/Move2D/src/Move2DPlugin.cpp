...
Move2DProcessParams<Move2DPlugin::Scalar>
Move2DPlugin::getProcessParams(const OfxPointD &renderScale) const {
...
void Move2DPlugin::changedParam(const OFX::InstanceChangedArgs &args,
                                const std::string &paramName) {}

bool Move2DPlugin::getRegionOfDefinition(
...
void
Move2DPlugin::getRegionsOfInterest(const OFX::RegionsOfInterestArguments &args,
...
bool Move2DPlugin::isIdentity(const OFX::RenderArguments &args,
