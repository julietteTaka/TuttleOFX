...
template <class View>
void Move2DProcess<View>::setup(const OFX::RenderArguments &args) {
...
template <class View>
void
Move2DProcess<View>::multiThreadProcessImages(const OfxRectI &procWindowRoW) {
  ...
  /*
  const OfxRectI procWindowSrc = translateRegion( procWindowRoW,
  this->_srcPixelRod );
