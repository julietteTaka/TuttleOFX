...
{
public:
    Manipulator( const interact::InteractInfos& infos, OFX::Double2DParam*
param, const TFrame& frame, const OFX::ChoiceParam* paramMode )
...
PinningOverlayInteract::PinningOverlayInteract(OfxInteractHandle handle,
  ...
  _interactScene.push_back(
      new interact::ParamPoint<interact::FrameClip, eCoordinateSystemXXcn>(
  ...
  activeOut3->push_back(
      new interact::IsActiveBooleanParamFunctor<>(_plugin->_paramOverlayOut));
  activeOut3->push_back(
      new interact::IsNotSecretParamFunctor<>(_plugin->_paramPointOut3));
  _interactScene.push_back(
      new interact::ParamPoint<interact::FrameClip, eCoordinateSystemXXcn>(
  ...
  activeIn3->push_back(
      new interact::IsActiveBooleanParamFunctor<>(_plugin->_paramOverlayOut));
  activeIn3->push_back(
      new interact::IsNotSecretParamFunctor<>(_plugin->_paramPointIn3));
  _interactScene.push_back(
      new interact::ParamPoint<interact::FrameClip, eCoordinateSystemXXcn>(
  ...
  /*
          _interactScene.setManipulator(
                new Manipulator<interact::FrameClip, eCoordinateSystemXXcn>(
     _infos, _plugin->_paramPointCentre, _plugin->_clipSrc,
     _plugin->_ParamManipulatorMode ),
...
{
   if( (args.keySymbol == kOfxKey_Control_L) || (args.keySymbol ==
kOfxKey_Control_R) )
   {
...
/*
void PinningOverlayInteract::calculCentre( const std::vector<
bounded_vector<double, 2> > pSelect)
{
...
void PinningOverlayInteract::rotatePts( std::vector< bounded_vector<double, 2> >
pSelect, double angle)
{
        //calcul centre
        //OfxPointD centre;
...
void PinningOverlayInteract::scalePts( std::vector< bounded_vector<double, 2> >
pSelect, double coef)
{
