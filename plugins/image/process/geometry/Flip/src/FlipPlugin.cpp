...
OfxRectI FlipPlugin::computeFlipRegion(const OfxTime time,
...
FlipProcessParams
FlipPlugin::getProcessParams(const OfxTime time,
...
void
FlipPlugin::getRegionsOfInterest(const OFX::RegionsOfInterestArguments &args,
                                 OFX::RegionOfInterestSetter &rois) {
  //	FlipProcessParams params = getProcessParams( args.time, args.renderScale
  //);
  //	if( params.flip )
  //	{
  //		/// @todo needs to transform args.regionOfInterest, like in the
  //compute function
  //	}
  //	if( params.flop )
  //	{
...
bool FlipPlugin::isIdentity(const OFX::RenderArguments &args,
