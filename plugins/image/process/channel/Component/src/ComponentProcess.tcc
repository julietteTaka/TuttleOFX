...
void ComponentProcess<SView, DView>::setup(const OFX::RenderArguments &args) {
  ...
  // get process params
  _params.grayMethod = static_cast<terry::color::components::EConvertToGray>(
      _plugin._paramToGrayMethod->getValue());
 ...
 */
template <class SView, class DView>
void ComponentProcess<SView, DView>::multiThreadProcessImages(
  ...
  SView src = subimage_view(this->_srcView, procWindowSrc.x1, procWindowSrc.y1,
