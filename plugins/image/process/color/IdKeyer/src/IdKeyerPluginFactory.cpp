 ...
 */
void IdKeyerPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::BooleanParamDescriptor *useAlpha =
      desc.defineBooleanParam(kParamUseAlpha);
  useAlpha->setLabel("Use alpha");
  useAlpha->setDefault(false);

  OFX::DoubleParamDescriptor *tolerance =
      desc.defineDoubleParam(kParamTolerance);
 ...
 */
OFX::ImageEffect *
IdKeyerPluginFactory::createInstance(OfxImageEffectHandle handle,
                                     OFX::EContext context) {
