...
void OCIOColorSpacePluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels(
      "TuttleOcioColorSpace", "OCIOColorSpace",
...
void
OCIOColorSpacePluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *inputSpace =
      desc.defineChoiceParam(kParamInputSpace);
  inputSpace->setLabel("Input Space");
  //////
  OFX::ChoiceParamDescriptor *outputSpace =
      desc.defineChoiceParam(kParamOutputSpace);
