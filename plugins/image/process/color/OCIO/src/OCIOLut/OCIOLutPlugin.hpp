...
public:
  ...
  OCIOLutProcessParams getProcessParams(const OfxPointD &renderScale =
  ...
  OCIO_NAMESPACE::Interpolation
  getOCIOInterpolationType(EInterpolationType tuttleInterpolationType) const {
