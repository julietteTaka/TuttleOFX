...
PrintProcessParams<PrintPlugin::Scalar>
PrintPlugin::getProcessParams(const OfxPointD &renderScale) const {
...
void PrintPlugin::changedParam(const OFX::InstanceChangedArgs &args,
                               const std::string &paramName) {
  updateParams();
}

bool PrintPlugin::isIdentity(const OFX::RenderArguments &args,
