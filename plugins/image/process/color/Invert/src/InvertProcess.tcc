...
template <class View> void InvertProcess<View>::preProcess() {
...
template <class View>
void
InvertProcess<View>::multiThreadProcessImages(const OfxRectI &procWindowRoW) {
  TUTTLE_LOG_ERROR("undefined template");
}

template <>
void InvertProcess<terry::rgba32f_view_t>::multiThreadProcessImages(
  ...
  invertRGBAPixels<terry::rgba32f_view_t>(
      src, dst, _params._red, _params._green, _params._blue, _params._alpha);
}

template <>
void InvertProcess<terry::rgba32_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBAPixels<terry::rgba32_view_t>(src, dst, _params._red, _params._green,
                                         _params._blue, _params._alpha);
}

template <>
void InvertProcess<terry::rgba16_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBAPixels<terry::rgba16_view_t>(src, dst, _params._red, _params._green,
                                         _params._blue, _params._alpha);
}

template <>
void InvertProcess<terry::rgba8_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBAPixels<terry::rgba8_view_t>(src, dst, _params._red, _params._green,
                                        _params._blue, _params._alpha);
}

template <>
void InvertProcess<terry::rgb32f_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBPixels<terry::rgb32f_view_t>(src, dst, _params._red, _params._green,
                                        _params._blue);
}

template <>
void InvertProcess<terry::rgb32_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBPixels<terry::rgb32_view_t>(src, dst, _params._red, _params._green,
                                       _params._blue);
}

template <>
void InvertProcess<terry::rgb16_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBPixels<terry::rgb16_view_t>(src, dst, _params._red, _params._green,
                                       _params._blue);
}

template <>
void InvertProcess<terry::rgb8_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
  ...
  invertRGBPixels<terry::rgb8_view_t>(src, dst, _params._red, _params._green,
                                      _params._blue);
}

template <>
void InvertProcess<terry::gray32f_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
...
template <>
void InvertProcess<terry::gray32_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
...
template <>
void InvertProcess<terry::gray16_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
...
template <>
void InvertProcess<terry::gray8_view_t>::multiThreadProcessImages(
    const OfxRectI &procWindowRoW) {
  using namespace boost::gil;
  OfxRectI procWindowOutput =
      this->translateRoWToOutputClipCoordinates(procWindowRoW);
...
void InvertProcess<View>::invertRGBAPixels(WorkView &src, WorkView &dst,
...
template <class View>
template <typename WorkView>
void InvertProcess<View>::invertRGBPixels(WorkView &src, WorkView &dst,
                                          bool red, bool green, bool blue) {
  using namespace boost::gil;
  using namespace terry;
  using namespace terry::algorithm;
  ...
  if (red && green && blue) {
    transform_pixels_progress(
        src, dst,
        transform_pixel_by_channel_t<terry::color::channel_invert_t>(), *this);
  } else {
    {
      typedef red_t LocalChannel;
      if (red) {
...
template <class View>
template <typename WorkView>
void InvertProcess<View>::invertGrayPixels(WorkView &src, WorkView &dst,
                                           bool gray) {
  using namespace boost::gil;
  using namespace terry;
  using namespace terry::algorithm;
