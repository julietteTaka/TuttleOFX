...
InvertProcessParams
InvertPlugin::getProcessParams(const OfxPointD &renderScale) const {
...
void InvertPlugin::render(const OFX::RenderArguments &args) {
  ...
  case OFX::ePixelComponentRGBA: {
    doGilRender<InvertProcess, false, boost::gil::rgba_layout_t>(*this, args,
                                                                 bitDepth);
    return;
  }
  case OFX::ePixelComponentRGB: {
    doGilRender<InvertProcess, false, boost::gil::rgb_layout_t>(*this, args,
                                                                bitDepth);
    return;
  }
  case OFX::ePixelComponentAlpha: {
    doGilRender<InvertProcess, false, boost::gil::gray_layout_t>(*this, args,
                                                                 bitDepth);
    return;
  }
