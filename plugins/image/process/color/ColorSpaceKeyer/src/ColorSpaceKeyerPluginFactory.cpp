...
void ColorSpaceKeyerPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setOverlayInteractDescriptor(
      new OFX::DefaultEffectOverlayWrap<ColorSpaceKeyerOverlayDescriptor>());
}
 ...
 */
void ColorSpaceKeyerPluginFactory::describeInContext(
 ...
 */
OFX::ImageEffect *
ColorSpaceKeyerPluginFactory::createInstance(OfxImageEffectHandle handle,
