...
const static std::string kBoolDiscretizationDisplay =
    "discretizationDisplayBool";
const static std::string kBoolDiscretizationDisplayLabel =
...
const static std::string kIntNumberOfDivisonGeodesicForm =
    "numberOfDivisonGeodesicForm";
const static std::string kIntNumberOfDivisonGeodesicFormLabel = "Precision";

// Reset transformation button
const static std::string kPushButtonResetTransformationParameters =
    "ResetTransformation";
const static std::string kPushButtonResetTransformationParametersLabel =
...
const static std::string kBoolColorSelectionDisplay =
    "displayColorSelectionDisplay";
const static std::string kBoolColorSelectionDisplayLabel =
    "Display color selection";

// Spill selection display
const static std::string kBoolSpillSelectionDisplay =
    "displaySpillSelectionDisplay";
const static std::string kBoolSpillSelectionDisplayLabel =
    "Display spill selection";
