 ...
 * @param effect
 */
ColorSpaceKeyerOverlay::ColorSpaceKeyerOverlay(OfxInteractHandle handle,
 ...
 */
void
ColorSpaceKeyerOverlay::updateModelView(const Ofx3DPointD &rotationCenter) {
 ...
 */
void ColorSpaceKeyerOverlay::drawWarning(const Ofx3DPointD &centerPoint,
                                         const double ratio) {
