...
public:
  ...
  // typedef typename boost::gil::channel_convert_to_unsigned<d_channel_t>::type
  // channel_t;
...
protected:
  ...
  /*
          ...
          void processChannel( View& src, View& dst, bool process, Pixel& ratio,
     Pixel& sMin, Pixel& dMin );*/

  template <class WorkView, typename LocalChannel, typename P>
  void processChannel(View &src, View &dst, bool process, P &ratio, P &sMin,
                      P &dMin);
