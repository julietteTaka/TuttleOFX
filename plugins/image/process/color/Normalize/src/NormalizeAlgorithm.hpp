...
void analyseChannel(View &src, typename View::value_type &min,
 ...
 */
template <class View>
void analyseInputMinMax(const View &src, const EParamAnalyseMode analyseMode,
  ...
  case eParamAnalyseModeLuminosity: {
    ...
    pixel_minmax_by_channel_t<typename LocalView::value_type> minmax(
        localView(0, 0));
    transform_pixels_progress(localView, minmax, p);
    static_fill(min, minmax.min[0]);
    static_fill(max, minmax.max[0]);
...
template <>
void analyseInputMinMax(const boost::gil::rgb32f_view_t &src,
  ...
  case eParamAnalyseModeR: {
    ...
    pixel_minmax_by_channel_t<LocalView::type::value_type> minmax(
        localView(0, 0));
    transform_pixels_progress(localView, minmax, progress);
    static_fill(min, minmax.min[0]);
    static_fill(max, minmax.max[0]);
...
template <>
void analyseInputMinMax(const boost::gil::rgb16_view_t &src,
                        const EParamAnalyseMode analyseMode,
...
template <>
void analyseInputMinMax(const boost::gil::rgb8_view_t &src,
                        const EParamAnalyseMode analyseMode,
...
template <>
void analyseInputMinMax(const boost::gil::gray32f_view_t &src,
                        const EParamAnalyseMode analyseMode,
  ...
  case eParamAnalyseModeLuminosity: {
    ...
    typedef color_converted_view_type<gray32f_view_t, PixelGray>::type
    LocalView;
    LocalView localView(src);
    pixel_minmax_by_channel_t<LocalView::value_type> minmax(localView(0, 0));
    transform_pixels_progress(localView, minmax, p);
...
template <>
void analyseInputMinMax(const boost::gil::gray16_view_t &src,
                        const EParamAnalyseMode analyseMode,
...
template <>
void analyseInputMinMax(const boost::gil::gray8_view_t &src,
                        const EParamAnalyseMode analyseMode,
