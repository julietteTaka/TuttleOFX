...
void NormalizePluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleNormalize", "Normalize", "Normalize");
...
void NormalizePluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *analyse =
      desc.defineChoiceParam(kParamAnalyseMode);
  ...
  OFX::PushButtonParamDescriptor *analyseNow =
      desc.definePushButtonParam(kParamAnalyseNow);
  ...
  OFX::RGBAParamDescriptor *srcMinColor =
      desc.defineRGBAParam(kParamSrcCustomColorMin);
  srcMinColor->setLabel("Min");
  srcMinColor->setDefault(0.0, 0.0, 0.0, 0.0);
  srcMinColor->setParent(srcGroup);

  OFX::RGBAParamDescriptor *srcMaxColor =
      desc.defineRGBAParam(kParamSrcCustomColorMax);
  ...
  OFX::RGBAParamDescriptor *dstMinColor =
      desc.defineRGBAParam(kParamDstCustomColorMin);
  dstMinColor->setLabel("Min");
  dstMinColor->setDefault(0.0, 0.0, 0.0, 0.0);
  dstMinColor->setParent(dstGroup);

  OFX::RGBAParamDescriptor *dstMaxColor =
      desc.defineRGBAParam(kParamDstCustomColorMax);
 ...
 */
OFX::ImageEffect *
NormalizePluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
