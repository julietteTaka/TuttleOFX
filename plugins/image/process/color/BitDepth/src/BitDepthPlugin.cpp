  ...
  case OFX::ePixelComponentRGBA: {
    ...
    case OFX::eBitDepthNone: {
      BOOST_THROW_EXCEPTION(OFX::Exception::Suite(
          kOfxStatErrUnsupported, "Bit depth (" +
                                      mapBitDepthEnumToString(srcBitDepth) +
  ...
  case OFX::ePixelComponentNone: {
    BOOST_THROW_EXCEPTION(exception::Unsupported()
                          << exception::user() + "Pixel components (" +
                                 mapPixelComponentEnumToString(srcComponents) +
...
void BitDepthPlugin::setupDestView(const OFX::RenderArguments &args) {
  ...
  case OFX::ePixelComponentRGBA: {
    ...
    case OFX::eBitDepthNone: {
      BOOST_THROW_EXCEPTION(exception::Unsupported()
                            << exception::user() + "Bit depth (" +
                                   mapBitDepthEnumToString(dstBitDepth) +
                                   ") not recognized by the plugin.");
    }
    }
    break;
