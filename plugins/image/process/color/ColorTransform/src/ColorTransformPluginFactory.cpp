...
void ColorTransformPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleColorTransform", "ColorTransform", "ColorTransform");
 ...
 */
void
ColorTransformPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::DoubleParamDescriptor *paramHueShift =
      desc.defineDoubleParam(kParamHueShift);
  paramHueShift->setLabel("Hue Shift");
  paramHueShift->setDefault(0.0);
  paramHueShift->setDisplayRange(0.0, 1.0);

  OFX::DoubleParamDescriptor *paramSaturation =
      desc.defineDoubleParam(kParamSaturation);
  ...
  OFX::DoubleParamDescriptor *paramContrastRGB =
      desc.defineDoubleParam(kParamContrastRGB);
  ...
  OFX::RGBAParamDescriptor *paramContrast =
      desc.defineRGBAParam(kParamContrast);
  paramContrast->setLabel("Contrast");
  paramContrast->setDefault(1.0, 1.0, 1.0, 1.0);

  OFX::DoubleParamDescriptor *paramBrightnessRGB =
      desc.defineDoubleParam(kParamBrightnessRGB);
  ...
  OFX::RGBAParamDescriptor *paramBrightness =
      desc.defineRGBAParam(kParamBrightness);
  paramBrightness->setLabel("Brightness");
  paramBrightness->setDefault(1.0, 1.0, 1.0, 1.0);

  OFX::DoubleParamDescriptor *paramOffsetRGB =
      desc.defineDoubleParam(kParamOffsetRGB);
  ...
  OFX::DoubleParamDescriptor *paramPivotRGB =
 ...
 */
OFX::ImageEffect *
ColorTransformPluginFactory::createInstance(OfxImageEffectHandle handle,
                                            OFX::EContext context) {
