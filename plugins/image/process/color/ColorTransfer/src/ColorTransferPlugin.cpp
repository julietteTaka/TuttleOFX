...
void ColorTransferPlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
void ColorTransferPlugin::getRegionsOfInterest(
...
void ColorTransferPlugin::render(const OFX::RenderArguments &args) {
  ...
  case OFX::ePixelComponentRGBA: {
    doGilRender<ColorTransferProcess, false, boost::gil::rgba_layout_t>(
        *this, args, bitDepth);
    return;
  }
  case OFX::ePixelComponentRGB: {
    doGilRender<ColorTransferProcess, false, boost::gil::rgb_layout_t>(
        *this, args, bitDepth);
    return;
  }
