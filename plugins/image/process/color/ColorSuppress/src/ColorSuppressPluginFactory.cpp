 ...
 */
void
ColorSuppressPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::DoubleParamDescriptor *redSuppress =
      desc.defineDoubleParam(kParamRedSuppressRate);
  ...
  OFX::DoubleParamDescriptor *greenSuppress =
      desc.defineDoubleParam(kParamGreenSuppressRate);
  ...
  OFX::DoubleParamDescriptor *blueSuppress =
      desc.defineDoubleParam(kParamBlueSuppressRate);
  ...
  OFX::DoubleParamDescriptor *cyanSuppress =
      desc.defineDoubleParam(kParamCyanSuppressRate);
  ...
  OFX::DoubleParamDescriptor *magentaSuppress =
      desc.defineDoubleParam(kParamMagentaSuppressRate);
  ...
  OFX::DoubleParamDescriptor *yellowSuppress =
      desc.defineDoubleParam(kParamYellowSuppressRate);
  ...
  OFX::BooleanParamDescriptor *preserveLuma =
      desc.defineBooleanParam(kParamPreserveLuma);
  preserveLuma->setLabel("Preserve Luminance");
  preserveLuma->setHint("Preserve image luminosity.");
  preserveLuma->setDefault(false);

  OFX::BooleanParamDescriptor *obeyAlpha =
      desc.defineBooleanParam(kParamObeyAlpha);
