...
void BasicKeyerPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleBasicKeyer", "BasicKeyer", "Basic keyer");
 ...
 */
void
BasicKeyerPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
 ...
 */
OFX::ImageEffect *
BasicKeyerPluginFactory::createInstance(OfxImageEffectHandle handle,
                                        OFX::EContext context) {
