...
public:
  ...
  inline Color getColor(Color const &color) const {
    return _interpolator->interpolate(this, color);
  }
  inline Color getColor(double _r, double _g, double _b) const {
    return _interpolator->interpolate(this, _r, _g, _b);
  }
  inline void setIndexedColor(int _x, int _y, int _z, Color _color);
  inline void setIndexedValues(int _x, int _y, int _z, double _r, double _g,
                               double _b);
...
inline void Lut3D::setIndexedValues(int _x, int _y, int _z, double _r,
                                    double _g, double _b) {
  int ref = getIndex(_x, _y, _z);
