 ...
 */
template <class View>
void ColorSpaceProcess<View>::multiThreadProcessImages(
  ...
  terry::colorspace_pixels_progress( &csAPI, _params._gradationIn,
  _params._layoutIn, _params._tempColorIn, _params._gradationOut,
