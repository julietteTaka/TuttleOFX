...
ColorSpaceProcessParams ColorSpacePlugin::getProcessParams() const {
  ...
  params._gradationIn =
      static_cast<EParamGradationLaw>(_paramInGradationLaw->getValue());
  ...
  params._gradationOut =
      static_cast<EParamGradationLaw>(_paramOutGradationLaw->getValue());
  ...
  params._tempColorIn =
      static_cast<EColorTemperature>(_paramInColorTemp->getValue());
  params._tempColorOut =
      static_cast<EColorTemperature>(_paramOutColorTemp->getValue());

  return params;
}

bool ColorSpacePlugin::isIdentity(const OFX::RenderArguments &args,
...
void ColorSpacePlugin::changedParam(const OFX::InstanceChangedArgs &args,
