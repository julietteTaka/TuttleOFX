 ...
 */
void FadePluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
                                          OFX::EContext context) {
  OFX::ClipDescriptor *srcClipFrom =
      desc.defineClip(kOfxImageEffectTransitionSourceFromClipName);
  ...
  OFX::ClipDescriptor *srcClipTo =
      desc.defineClip(kOfxImageEffectTransitionSourceToClipName);
 ...
 */
OFX::ImageEffect *FadePluginFactory::createInstance(OfxImageEffectHandle handle,
                                                    OFX::EContext context) {
