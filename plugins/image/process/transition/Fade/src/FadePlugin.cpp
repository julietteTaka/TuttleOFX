...
FadePlugin::FadePlugin(OfxImageEffectHandle handle) : OFX::ImageEffect(handle) {
...
void FadePlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
// bool FadePlugin::getRegionOfDefinition( const
...
bool FadePlugin::isIdentity(const OFX::RenderArguments &args,
