...
template <typename Scalar> struct MergeProcessParams {
  EParamRod _rod;
...
public:
  MergeProcessParams<Scalar> getProcessParams(const OfxPointD &renderScale =
...
private:
  template <class View> void render(const OFX::RenderArguments &args);
