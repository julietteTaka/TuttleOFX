#ifndef _TUTTLE_PLUGIN_LIBAV_LIBAVAUDIOPRESET_HPP_
#define _TUTTLE_PLUGIN_LIBAV_LIBAVAUDIOPRESET_HPP_
...
public:
  LibAVAudioPreset(const std::string &id) : presetID(id) {
