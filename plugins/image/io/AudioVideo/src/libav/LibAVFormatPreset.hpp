#ifndef _TUTTLE_PLUGIN_LIBAV_LIBAVFORMATPRESET_HPP_
#define _TUTTLE_PLUGIN_LIBAV_LIBAVFORMATPRESET_HPP_
...
public:
  LibAVFormatPreset(const std::string &id) : presetID(id) {
  ...
  static void getPresetList(std::vector<std::string> &presetID,
    ...
    LibAVPresetParser::getPresetList(presetID, presetLabelID,
                                     kPresetFormatExtension);
  }
