#ifndef _TUTTLE_PLUGIN_LIBAV_LIBAVVIDEOPRESET_HPP_
#define _TUTTLE_PLUGIN_LIBAV_LIBAVVIDEOPRESET_HPP_
...
public:
  LibAVVideoPreset(const std::string &id) : presetID(id) {
