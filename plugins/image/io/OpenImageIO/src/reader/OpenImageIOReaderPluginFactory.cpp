 ...
 */
void
OpenImageIOReaderPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  supportedExtensions += "bmp", "cin", "dds", "dpx", "exr", "fits", "hdr",
      ...
      "pgm", "png", "pnm", "ppm", "pic", "psd", "rgbe", "sgi", "tga", "tif",
      "tiff", "tpic", "tx", "webp";
 ...
 */
void OpenImageIOReaderPluginFactory::describeInContext(
 ...
 */
OFX::ImageEffect *
OpenImageIOReaderPluginFactory::createInstance(OfxImageEffectHandle handle,
