...
OpenImageIOReaderProcessParams
OpenImageIOReaderPlugin::getProcessParams(const OfxTime time) {
...
void OpenImageIOReaderPlugin::changedParam(const OFX::InstanceChangedArgs &args,
                                           const std::string &paramName) {
  ReaderPlugin::changedParam(args, paramName);
}

bool OpenImageIOReaderPlugin::getRegionOfDefinition(
  ...
  boost::scoped_ptr<OpenImageIO::ImageInput> in(
...
void OpenImageIOReaderPlugin::getClipPreferences(
