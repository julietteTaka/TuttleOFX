 ...
 */
template <class View>
void DPXWriterProcess<View>::multiThreadProcessImages(
  ...
  writer.Start();
  writer.SetFileInfo(_params._filepath.c_str(), 0, "TuttleOFX DPX Writer",
                     _params._project.c_str(), _params._copyright.c_str(), ~0,
                     _params._swapEndian);
  ...
  writer.SetElement(0, _params._descriptor, _params._iBitDepth,
                    _params._transfer, _params._colorimetric, _params._packed,
                    _params._encoding);
...
void DPXWriterProcess<View>::writeImage(::dpx::Writer &writer, View &src,
