...
DPXWriterProcessParams DPXWriterPlugin::getProcessParams(const OfxTime time) {
  ...
  case 24:
    ...
    default:
      BOOST_THROW_EXCEPTION(exception::ImageFormat()
                            << exception::user(
                                   "Dpx: unknown input channel type."));
      break;
    }
    break;
  default:
  ...
  default:
    params._transfer =
        static_cast< ::dpx::Characteristic>(_transfer->getValue());
    break;
  }
  ...
  default:
    params._colorimetric =
        static_cast< ::dpx::Characteristic>(_colorimetric->getValue());
    break;
  }
  ...
  params._orientation =
      static_cast< ::dpx::Orientation>(_orientation->getValue());
...
void DPXWriterPlugin::render(const OFX::RenderArguments &args) {
  ...
  case eTuttlePluginBitDepth8:
    ...
    case OFX::eBitDepthNone:
      BOOST_THROW_EXCEPTION(exception::BitDepthMismatch()
                            << exception::user(
                                   "Dpx: Unable to write upper bit depth"));
      break;
    case OFX::eBitDepthUShort:
    case OFX::eBitDepthFloat:
      switch (components) {
      case OFX::ePixelComponentAlpha:
        doGilRender<DPXWriterProcess, false, boost::gil::gray_layout_t>(
            *this, args, eOfxBitDepth);
        break;
      case OFX::ePixelComponentRGB:
        doGilRender<DPXWriterProcess, false, boost::gil::rgb_layout_t>(
            *this, args, eOfxBitDepth);
        break;
      case OFX::ePixelComponentRGBA:
        doGilRender<DPXWriterProcess, false, boost::gil::rgba_layout_t>(
            *this, args, eOfxBitDepth);
        break;
      default:
        BOOST_THROW_EXCEPTION(exception::InputMismatch()
                              << exception::user("Dpx: Unknown component."));
        break;
      }
      return;
  ...
  case eTuttlePluginBitDepth10:
    ...
    case OFX::eBitDepthUShort: // break; // @TODO temporary use GIL, the
                               // conversion Gray => RGBA provide a segfault
                               // after writer.Finish() function.
    case OFX::eBitDepthUByte:
    case OFX::eBitDepthFloat: {
      switch (components) {
      case OFX::ePixelComponentAlpha:
  ...
  if (!stream.Open(filename.c_str())) {
    BOOST_THROW_EXCEPTION(exception::File()
                          << exception::user(
                                 "Dpx: Unable to open output file"));
  }
  ...
  writer.SetFileInfo(filename.c_str(), 0, "TuttleOFX DPX Writer",
                     params._project.c_str(), params._copyright.c_str(), ~0,
                     params._swapEndian);
  ...
  // const std::size_t rowBytesToCopy = size.x * 4; // allocation of 4 channels,
  // to allow conversion after on this buffer (Gray=>RGBA). Better option to do
  // this ?
  ...
  case ::dpx::kUserDefinedDescriptor:
    ...
    default:
      BOOST_THROW_EXCEPTION(exception::ImageFormat()
                            << exception::user(
                                   "Dpx: Unable to write user defined"));
      break;
    }
    break;
  case ::dpx::kRed:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          ...
          << exception::user("Dpx: Unable to write Red channel (input is " +
  ...
  case ::dpx::kGreen:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write Green channel (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kBlue:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write Blue channel (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kAlpha:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write Alpha channel (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kLuma:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write Luma channel (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kColorDifference:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user(
                 "Dpx: Unable to write ColorDifference channel (input is " +
                 inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kDepth:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write Depth channel (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kCompositeVideo:
    ...
    default:
      BOOST_THROW_EXCEPTION(exception::ImageFormat()
                            << exception::user(
                                   "Dpx: Unable to write channel (input is " +
                                   inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kRGB:
    ...
    default: {
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write RGB channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    }
  ...
  case ::dpx::kRGBA:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write RGBA channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kABGR:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write ABGR channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kCbYCrY:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write CbYCrY channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kCbYACrYA:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user(
                 "Dpx: Unable to write CbYCrYA channels (input is " +
                 inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kCbYCr:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write CbYCr channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kCbYCrA:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write CbYCrA channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined2Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write 2 channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined3Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(exception::ImageFormat()
                            << exception::user(
                                   "Dpx: Unable to write 3 channel (input is " +
                                   inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined4Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(exception::ImageFormat()
                            << exception::user(
                                   "Dpx: Unable to write 4 channel (input is " +
                                   inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined5Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write 5 channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined6Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write 6 channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined7Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write 7 channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUserDefined8Comp:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user("Dpx: Unable to write 8 channels (input is " +
                             inputComponentString + ")."));
      break;
    }
    break;
  case ::dpx::kUndefinedDescriptor:
    ...
    default:
      BOOST_THROW_EXCEPTION(
          exception::ImageFormat()
          << exception::user(
                 "Dpx: Unable to write undefined descriptor (input is " +
                 inputComponentString + ")."));
      break;
    }
    break;
  ...
  writer.SetElement(0, params._descriptor, params._iBitDepth, params._transfer,
                    params._colorimetric, params._packed, params._encoding);

  if (!writer.WriteHeader()) {
    BOOST_THROW_EXCEPTION(exception::Data()
                          << exception::user(
                                 "Dpx: Unable to write data (DPX Header)"));
  }
  if (!writer.WriteElement(0, &data.front(), dataSize)) {
    BOOST_THROW_EXCEPTION(exception::Data()
                          << exception::user(
                                 "Dpx: Unable to write data (DPX User Data)"));
  }

  if (!writer.Finish()) {
    BOOST_THROW_EXCEPTION(exception::Data()
                          << exception::user(
                                 "Dpx: Unable to write data (DPX finish)"));
  }

  stream.Close();
}

void DPXWriterPlugin::changedParam(const OFX::InstanceChangedArgs &args,
