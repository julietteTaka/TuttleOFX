...
void DPXWriterPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setDescription(
      "Digital Picture Exchange (DPX), ANSI/SMPTE standard (268M-2003)");
...
void DPXWriterPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *colorimetric =
      desc.defineChoiceParam(kParamColorimetric);
  ...
  OFX::BooleanParamDescriptor *swapEndian =
      desc.defineBooleanParam(kParamSwapEndian);
  ...
  project->setDefault("");
  OFX::StringParamDescriptor *copyright =
      desc.defineStringParam(kParamCopyright);
