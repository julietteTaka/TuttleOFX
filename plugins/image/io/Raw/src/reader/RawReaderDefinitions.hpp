...
static const std::string kParamGreyboxPointHint =
    "Coordinates of the rectangle that is used to calculate the white balance. "
    "X and Y are coordinates of the left-top rectangle corner.";

static const std::string kParamGreyboxSize = "greyboxsize";
static const std::string kParamGreyboxSizeLabel = "GreyBox Size";
static const std::string kParamGreyboxSizeHint =
    "Coordinates of the rectangle that is used to calculate the white balance. "
...
static const std::string kParamRedAbberHint =
...
static const std::string kParamBlueAbberHint =
    "Correction of chromatic aberrations.";
...
static const std::string kParamGammaToeHint = "Slope for linear part (so "
                                              "called toe slope). Set to zero "
...
static const std::string kParamThresholdHint =
...
static const std::string kParamFourColorRgbHint =
...
static const std::string kParamHighlightHint =
    "Highlight mode\t rebuild : Low  numbers favor whites; high numbers favor "
    "colors. 5 as a compromise.";
...
static const std::string kParamInterpolationVng =
    "VNG Variable Number of Gradients";
static const std::string kParamInterpolationPpg =
    "PPG Patterned Pixel Grouping";
static const std::string kParamInterpolationAhd =
...
static const std::string kParamExposureHint =
    "Exposure shift in linear scale. Usable range from 0.25 (2-stop darken) to "
    "8.0 (3-stop lighter). Default: 1.0 (no exposure shift).";

static const std::string kParamExposurePreserve = "exposurepreserve";
static const std::string kParamExposurePreserveLabel =
    "Exposure preserve highlights";
static const std::string kParamExposurePreserveHint =
    "Preserve highlights when lighten the image. Usable range from 0.0 (no "
