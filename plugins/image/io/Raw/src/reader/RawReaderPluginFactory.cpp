...
void RawReaderPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  supportedExtensions += "3fr", "ari", "arw", "bay", "crw", "cr2", "cap", "dng",
      "dcs", "dcr", "dng", "drf", "eip", "erf", "fff", "iiq", "k25", "kdc",
      "mef", "mos", "mrw", "nef", "nrw", "obm", "orf", "pef", "ptx", "pxn",
      "r3d", "rad", "raf", "rw2", "raw", "rwl", "rwz", "srf", "sr2", "srw",
      "x3f";
...
void RawReaderPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::Double2DParamDescriptor *greyboxPoint =
      desc.defineDouble2DParam(kParamGreyboxPoint);
  ...
  OFX::Double2DParamDescriptor *greyboxSize =
      desc.defineDouble2DParam(kParamGreyboxSize);
  ...
  OFX::DoubleParamDescriptor *greenAbber =
      desc.defineDoubleParam(kParamBlueAbber);
  ...
  OFX::DoubleParamDescriptor *gammaPower =
      desc.defineDoubleParam(kParamGammaPower);
  ...
  OFX::DoubleParamDescriptor *threshold =
      desc.defineDoubleParam(kParamThreshold);
  ...
  OFX::BooleanParamDescriptor *fourColorRGB =
      desc.defineBooleanParam(kParamFourColorRgb);
  fourColorRGB->setLabel(kParamFourColorRgbLabel);
  fourColorRGB->setHint(kParamFourColorRgbHint);
  fourColorRGB->setDefault(false);

  OFX::ChoiceParamDescriptor *highlight =
      desc.defineChoiceParam(kParamHighlight);
  ...
  OFX::ChoiceParamDescriptor *interpolation =
      desc.defineChoiceParam(kParamInterpolation);
  ...
  OFX::DoubleParamDescriptor *preserve =
      desc.defineDoubleParam(kParamExposurePreserve);
  ...
  OFX::ChoiceParamDescriptor *whitebalance =
      desc.defineChoiceParam(kParamWhiteBalance);
  ...
  OFX::ChoiceParamDescriptor *filtering =
      desc.defineChoiceParam(kParamFiltering);
  ...
  OFX::StringParamDescriptor *manufacturer =
      desc.defineStringParam(kParamManufacturer);
  ...
  OFX::StringParamDescriptor *date =
      desc.defineStringParam(kParamDateOfShooting);
 ...
 */
OFX::ImageEffect *
RawReaderPluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
