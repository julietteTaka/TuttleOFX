...
#define COMP_24_CS                                                             \
  1041666 /*Maximum size per color component for 2K & 4K @ 24fps*/
...
// On tente de trouver un magic number. Based on some files found on various
// disks. Specs not availiable at date of writing
#define MAYBE_MAGIC 0x51ff4fff
#define MAYBE_REV_MAGIC 0xff4fff51
