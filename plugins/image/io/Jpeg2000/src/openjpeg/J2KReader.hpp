...
public:
  ...
  void close();
  inline bool componentsConform(); ///< Check if components have the same
                                   ///properties
  // Getters
  inline const size_t components() const; ///< Get number of components
  inline const size_t width(const size_t nc =
                                0) const; ///< Get width of nc component
  inline const size_t height(const size_t nc =
                                 0) const; ///< Get height of nc component
  inline const size_t precision(const size_t nc =
                                    0) const; ///< Get precision of nc component
  inline const uint8_t *compData(const size_t nc) const; ///< Get the nc
                                                         ///component data
