...
Jpeg2000ProcessParams
Jpeg2000WriterPlugin::getProcessParams(const OfxTime time) {
...
void Jpeg2000WriterPlugin::changedParam(const OFX::InstanceChangedArgs &args,
