...
static const std::string kParamFastUpsamplingHint =
    "Fast upsampling U and V channels. Can introduce distorsions.";
...
static const std::string kParamOptimizationHint =
