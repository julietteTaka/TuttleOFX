...
void TurboJpegReaderPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleTurboJpegReader", "TurboJpegReader",
 ...
 */
void TurboJpegReaderPluginFactory::describeInContext(
  ...
  OFX::BooleanParamDescriptor *fastupsampling =
      desc.defineBooleanParam(kParamFastUpsampling);
 ...
 */
OFX::ImageEffect *
TurboJpegReaderPluginFactory::createInstance(OfxImageEffectHandle handle,
