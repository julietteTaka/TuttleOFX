...
ImageMagickWriterProcessParams
ImageMagickWriterPlugin::getProcessParams(const OfxTime time) {
...
void ImageMagickWriterPlugin::render(const OFX::RenderArguments &args) {
  ...
  case OFX::ePixelComponentRGBA: {
    doGilRender<ImageMagickWriterProcess, false, boost::gil::rgba_layout_t>(
        *this, args, bitDepth);
    return;
  }
