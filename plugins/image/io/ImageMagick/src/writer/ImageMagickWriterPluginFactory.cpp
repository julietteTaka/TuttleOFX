 ...
 */
void
ImageMagickWriterPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  supportedExtensions += "aai", "art", "arw", "avi", "avs", "bmp", "bmp2",
      "bmp3", "cals", "cgm", "cin", "cmyk", "cmyka", "cr2", "crw", "cur", "cut",
      "dcm", "dcr", "dcx", "dib", "djvu", "dng", "dot", "dpx", "emf", "epdf",
      "epi", "eps", "eps2", "eps3", "epsf", "epsi", "ept", "exr", "fax", "fig",
      "fits", "fpx", "gif", "gplt", "gray", "hdr", "hpgl", "hrz", "html", "ico",
      "info", "inline", "jbig", "jng", "jp2", "jpc", "jpg", "jpeg", "man",
      "mat", "miff", "mono", "mng", "m2v", "mpeg", "mpc", "mpr", "mrw", "msl",
      "mtv", "mvg", "nef", "orf", "otb", "p7", "palm", "pam", "pbm", "pcd",
      "pcds", "pcl", "pcx", "pdb", "pdf", "pef", "pfa", "pfb", "pfm", "pgm",
      "picon", "pict", "pix", "png", "png8", "png16", "png32", "pnm", "ppm",
      "ps", "ps2", "ps3", "psb", "psd", "ptif", "pwp", "rad", "rgb", "rgba",
      "rla", "rle", "sct", "sfw", "sgi", "shtml", "sid", "mrsid", "sun", "svg",
      "tga", "tiff", "tim", "tif", "txt", "uil", "uyvy", "vicar", "viff",
      "wbmp", "webp", "wmf", "wpg", "x", "xbm", "xcf", "xpm", "xwd", "x3f",
      "ycbcr", "ycbcra", "yuv";
 ...
 */
void ImageMagickWriterPluginFactory::describeInContext(
  ...
  // Controls
  OFX::StringParamDescriptor *filename =
      desc.defineStringParam(kTuttlePluginFilename);
  ...
  OFX::ChoiceParamDescriptor *bitDepth =
      desc.defineChoiceParam(kTuttlePluginBitDepth);
  ...
  OFX::PushButtonParamDescriptor *render =
      desc.definePushButtonParam(kParamWriterRender);
  render->setLabels("Render", "Render", "Render step");
  render->setHint("Force render (writing)");

  OFX::BooleanParamDescriptor *renderAlways =
      desc.defineBooleanParam(kParamWriterRenderAlways);
  renderAlways->setLabel("Render always");
  renderAlways->setCacheInvalidation(OFX::eCacheInvalidateValueAll);
  renderAlways->setDefault(false);

  OFX::IntParamDescriptor *forceNewRender =
      desc.defineIntParam(kParamWriterForceNewRender);
 ...
 */
OFX::ImageEffect *
ImageMagickWriterPluginFactory::createInstance(OfxImageEffectHandle handle,
