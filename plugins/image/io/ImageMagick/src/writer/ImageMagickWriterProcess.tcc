...
template <class View>
ImageMagickWriterProcess<View>::ImageMagickWriterProcess(
    ImageMagickWriterPlugin &instance)
 ...
 */
template <class View>
void ImageMagickWriterProcess<View>::multiThreadProcessImages(
...
template <class View>
template <class Bits>
void ImageMagickWriterProcess<View>::writeImage(View &src,
  ...
  //		imagemagick_write_view( filepath, flipped_up_down_view(
  // color_converted_view<OutPixelType>( src ) ), params._quality );
  //	}
  //	else
  //	{
  //		typedef pixel<Bits, layout<typename color_space_type<View>::type>
  //>
  // OutPixelType;
  //		imagemagick_write_view( filepath, flipped_up_down_view(
  // color_converted_view<OutPixelType>( src ) ) );
  //	}
}
}
}
