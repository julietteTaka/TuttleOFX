...
typedef any_image<boost::mpl::vector<
    rgba8_image_t, rgba16_image_t, rgba32f_image_t, rgb8_image_t, rgb16_image_t,
 ...
 */
template <class View>
void JpegReaderProcess<View>::multiThreadProcessImages(
...
/**
 */
template <class View> View &JpegReaderProcess<View>::readImage(View &dst) {
  any_image_t anyImg;
