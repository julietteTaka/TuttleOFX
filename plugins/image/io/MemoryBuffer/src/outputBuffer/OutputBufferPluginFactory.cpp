 ...
 */
void
OutputBufferPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::StringParamDescriptor *callbackPointer =
      desc.defineStringParam(kParamOutputCallbackPointer);
  ...
  OFX::StringParamDescriptor *customData =
      desc.defineStringParam(kParamOutputCustomData);
  ...
  OFX::StringParamDescriptor *callbackDestroyCustomData =
      desc.defineStringParam(kParamOutputCallbackDestroyCustomData);
 ...
 */
OFX::ImageEffect *
OutputBufferPluginFactory::createInstance(OfxImageEffectHandle handle,
                                          OFX::EContext context) {
