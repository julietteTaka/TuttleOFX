...
typedef any_image<boost::mpl::vector<
    gray8_image_t, gray16_image_t, gray32f_image_t, rgba8_image_t,
    rgba16_image_t, rgba32f_image_t, rgb8_image_t, rgb16_image_t,
 ...
 */
template <class View>
void PngReaderProcess<View>::multiThreadProcessImages(
...
/**
 */
template <class View> View &PngReaderProcess<View>::readImage(View &dst) {
  any_image_t anyImg;
