...
void EXRReaderPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *outRedIs =
      desc.defineChoiceParam(kParamOutputRedIs);
  ...
  OFX::ChoiceParamDescriptor *outGreenIs =
      desc.defineChoiceParam(kParamOutputGreenIs);
  ...
  OFX::ChoiceParamDescriptor *outBlueIs =
      desc.defineChoiceParam(kParamOutputBlueIs);
  ...
  OFX::ChoiceParamDescriptor *outAlphaIs =
      desc.defineChoiceParam(kParamOutputAlphaIs);
  ...
  OFX::ChoiceParamDescriptor *outputData =
      desc.defineChoiceParam(kParamOutputData);
  outputData->appendOption("display");
  outputData->appendOption("data");
  outputData->setLabel("Output Data");
  outputData->setDefault(0);

  OFX::ChoiceParamDescriptor *fileBitDepth =
      desc.defineChoiceParam(kParamFileBitDepth);
  ...
  fileBitDepth->setHint(
      ...
      "Data type is per channel in EXR. So we read the type of the first "
      "channel.");

  OFX::ChoiceParamDescriptor *compression =
      desc.defineChoiceParam(kParamCompression);
 ...
 */
OFX::ImageEffect *
EXRReaderPluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
