...
EXRWriterProcessParams EXRWriterPlugin::getProcessParams(const OfxTime time) {
  ...
  params._fileBitDepth =
      (ETuttlePluginFileBitDepth) this->_paramFileBitDepth->getValue();
  params._componentsType =
      (ETuttlePluginComponents)_paramComponentsType->getValue();
