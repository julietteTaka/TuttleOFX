#include "ColorCubeViewerAlgorithm.hpp"
...
template <class View>
ColorCubeViewerProcess<View>::ColorCubeViewerProcess(
    ColorCubeViewerPlugin &effect)
...
template <class View>
void ColorCubeViewerProcess<View>::setup(const OFX::RenderArguments &args) {
 ...
 */
template <class View>
void ColorCubeViewerProcess<View>::multiThreadProcessImages(
  ...
  Compute_alpha_pixel funct(
      false, _plugin._renderAttributes.geodesicFormColor,
