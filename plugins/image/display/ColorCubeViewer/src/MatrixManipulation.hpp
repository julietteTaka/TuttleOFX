...
typedef boost::array<double, 3> Axis; // axis X = (1,0,0)    Y = (0,1,0)   Z =
                                      // (0,0,1) or others

// Matrix product with a 3D vector and a 4*4 matrix
void productVectorMatrix(const Vect4 &v, const Matrix4 &m, Vect4 &result);

// Does the multiplication A=A*B : all the matrices are 4*4 and described
// column-major
...
// Create rotation matrix with rotation center (translate + rotate + inverse
// translate)
