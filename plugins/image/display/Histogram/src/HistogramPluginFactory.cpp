...
void HistogramPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setDescription("Histogram\n"
                      "This histogram  plugin allows user to create an alpha "
                      "mask using HSL & RGB curves. Output can be in gray "
                      "scale or directly in alpha channel (RGBA)."
  ...
  desc.setOverlayInteractDescriptor(
      new OFX::DefaultEffectOverlayWrap<HistogramOverlayDescriptor>());
 ...
 */
void HistogramPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
 ...
 */
OFX::ImageEffect *
HistogramPluginFactory::createInstance(OfxImageEffectHandle handle,
                                       OFX::EContext context) {
