...
HistogramOverlay::HistogramOverlay(OfxInteractHandle handle,
                                   OFX::ImageEffect *effect)
    : OFX::OverlayInteract(handle),
      _plugin(static_cast<HistogramPlugin *>(_effect)), _infos(effect),
 ...
 */
void HistogramOverlay::displaySelectedAreas(const OfxPointI &fullImgSize,
                                            const OfxPointI &imgSize,
 ...
 */
void HistogramOverlay::drawWarning(const Ofx3DPointD &centerPoint,
                                   const double ratio) {
