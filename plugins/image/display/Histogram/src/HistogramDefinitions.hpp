...
const static std::string kButtonAppendSelectionToCurveRGB =
    "AppendSelectionToCurveRGB";
const static std::string kButtonAppendSelectionToCurveHSL =
    "AppendSelectionToCurveHSL";

const static std::string kButtonAppendSelectionToCurveRGBLabel =
    "Append from selection";
const static std::string kButtonAppendSelectionToCurveHSLLabel =
    "Append from selection";
...
const static std::string kprecisionCurveFromSelection =
    "PrecisionCurvesFromSelection";
const static std::string kprecisionCurveFromSelectionLabel =
    "Curves from selection precision";
