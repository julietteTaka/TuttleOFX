...
/// @todo class HSLOverlay : public OFX::OverlayInteract (when Nuke overlay
/// works)
class HSLOverlay {
public:
  /*Class arguments*/
  ...
  /*Creator*/
  // HSLOverlay(OfxInteractHandle handle, OFX::ImageEffect* effect); (when Nuke
  // overlay works)
  HSLOverlay(HistogramPlugin *plugin); // temporary
