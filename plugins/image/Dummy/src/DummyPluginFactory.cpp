...
void DummyPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleDummy", "Dummy", "Tuttle Dummy Node");
...
void DummyPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::StringParamDescriptor *orginalNode =
      desc.defineStringParam("originalnode");
 ...
 */
OFX::ImageEffect *
DummyPluginFactory::createInstance(OfxImageEffectHandle handle,
                                   OFX::EContext context) {
