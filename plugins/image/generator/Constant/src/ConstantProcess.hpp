...
template <class View> struct ConstantParams {
  typedef typename View::value_type Pixel;
  Pixel _color;
};

template <class View> class ConstantProcess : public ImageGilProcessor<View> {
public:
  typedef typename View::value_type Pixel;
  typedef typename View::point_t Point;
  typedef typename terry::generator::ConstantColorViewFactory<
      Pixel>::ConstantVirtualView ConstantVirtualView;
