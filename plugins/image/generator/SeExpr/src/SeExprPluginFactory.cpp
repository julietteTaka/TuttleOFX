...
void SeExprPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setDescription(
      "SeExpr is a simple expression language that we use to provide"
 ...
 */
void SeExprPluginFactory::describeInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::Double2DParamDescriptor *textureOffset =
      desc.defineDouble2DParam(kParamTextureOffset);
 ...
 */
OFX::ImageEffect *
SeExprPluginFactory::createInstance(OfxImageEffectHandle handle,
                                    OFX::EContext context) {
