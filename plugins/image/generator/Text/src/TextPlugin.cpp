...
TextPlugin::TextPlugin(OfxImageEffectHandle handle) : GeneratorPlugin(handle) {
...
TextProcessParams
TextPlugin::getProcessParams(const OfxPointD &renderScale) const {
...
void
TextPlugin::getClipPreferences(OFX::ClipPreferencesSetter &clipPreferences) {
...
void TextPlugin::render_if(const OFX::RenderArguments &args,
                           boost::mpl::true_) {
  typedef typename View::value_type Pixel;
