...
static const std::string kParamCoordinateSystemNormalized =
    "coordinateSystemNormalized";
static const std::string kParamCoordinateSystemCanonical =
...
static const std::string kParamOutputLuminosityMinHSL =
    "outputLuminosityMinHSL";
static const std::string kParamOutputLuminosityMaxHSL =
