...
void ImageStatisticsPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  ...
  desc.setOverlayInteractDescriptor(new OFX::DefaultEffectOverlayWrap<
 ...
 */
void ImageStatisticsPluginFactory::describeInContext(
  ...
  OFX::ChoiceParamDescriptor *coordSystem =
      desc.defineChoiceParam(kParamCoordinateSystem);
  ...
  OFX::Double2DParamDescriptor *rectCenter =
      desc.defineDouble2DParam(kParamRectCenter);
  ...
  OFX::Double2DParamDescriptor *rectSize =
      desc.defineDouble2DParam(kParamRectSize);
  ...
  OFX::ChoiceParamDescriptor *chooseOutput =
      desc.defineChoiceParam(kParamChooseOutput);
  ...
  OFX::GroupParamDescriptor *outputGroup =
      desc.defineGroupParam(kParamOutputGroup);
  outputGroup->setLabel("Output");
  outputGroup->setAsTab();

  // -----------------------------------------------------------------------------

  OFX::GroupParamDescriptor *rgbaGroup =
      desc.defineGroupParam(kParamOutputGroupRGBA);
  rgbaGroup->setLabel("RGBA");
  rgbaGroup->setParent(outputGroup);
  rgbaGroup->setAsTab();

  OFX::RGBAParamDescriptor *outputAverage =
      desc.defineRGBAParam(kParamOutputAverage);
  outputAverage->setLabel("Average");
  outputAverage->setParent(rgbaGroup);
  outputAverage->setEvaluateOnChange(false);

  OFX::RGBAParamDescriptor *outputVariance =
      desc.defineRGBAParam(kParamOutputVariance);
  outputVariance->setLabel("Variance");
  outputVariance->setParent(rgbaGroup);
  outputVariance->setEvaluateOnChange(false);

  OFX::RGBAParamDescriptor *outputChannelMin =
      desc.defineRGBAParam(kParamOutputChannelMin);
  ...
  OFX::RGBAParamDescriptor *outputChannelMax =
      desc.defineRGBAParam(kParamOutputChannelMax);
  outputChannelMax->setLabel("Channels' max");
  outputChannelMax->setParent(rgbaGroup);
  outputChannelMax->setEvaluateOnChange(false);

  OFX::RGBAParamDescriptor *outputLuminosityMin =
      desc.defineRGBAParam(kParamOutputLuminosityMin);
  ...
  OFX::RGBAParamDescriptor *outputLuminosityMax =
      desc.defineRGBAParam(kParamOutputLuminosityMax);
  ...
  OFX::RGBAParamDescriptor *outputKurtosis =
      desc.defineRGBAParam(kParamOutputKurtosis);
  outputKurtosis->setLabel("Kurtosis");
  outputKurtosis->setParent(rgbaGroup);
  outputKurtosis->setEvaluateOnChange(false);

  OFX::RGBAParamDescriptor *outputSkewness =
      desc.defineRGBAParam(kParamOutputSkewness);
  ...
  OFX::GroupParamDescriptor *hslGroup =
      desc.defineGroupParam(kParamOutputGroupHSL);
  hslGroup->setLabel("HSL");
  hslGroup->setParent(outputGroup);
  hslGroup->setAsTab();

  OFX::Double3DParamDescriptor *outputAverageHSL =
      desc.defineDouble3DParam(kParamOutputAverageHSL);
  ...
  OFX::Double3DParamDescriptor *outputChannelMinHSL =
      desc.defineDouble3DParam(kParamOutputChannelMinHSL);
  ...
  OFX::Double3DParamDescriptor *outputChannelMaxHSL =
      desc.defineDouble3DParam(kParamOutputChannelMaxHSL);
  ...
  OFX::Double3DParamDescriptor *outputLuminosityMinHSL =
      desc.defineDouble3DParam(kParamOutputLuminosityMinHSL);
  ...
  OFX::Double3DParamDescriptor *outputLuminosityMaxHSL =
      desc.defineDouble3DParam(kParamOutputLuminosityMaxHSL);
  ...
  OFX::Double3DParamDescriptor *outputKurtosisHSL =
      desc.defineDouble3DParam(kParamOutputKurtosisHSL);
  ...
  OFX::Double3DParamDescriptor *outputSkewnessHSL =
      desc.defineDouble3DParam(kParamOutputSkewnessHSL);
