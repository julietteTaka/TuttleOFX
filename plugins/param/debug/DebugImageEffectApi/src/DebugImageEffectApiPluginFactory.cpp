 ...
 */
void
DebugImageEffectApiPluginFactory::describe(OFX::ImageEffectDescriptor &desc) {
  desc.setLabels("TuttleDebugImageEffectApi", "DebugImageEffectApi",
                 "Plugin which displays informations about the host and all "
                 "plugin inputs.");
 ...
 */
void DebugImageEffectApiPluginFactory::describeInContext(
  ...
  OFX::DoubleParamDescriptor *currentTime =
      desc.defineDoubleParam(kCurrentTime);
 ...
 */
OFX::ImageEffect *
DebugImageEffectApiPluginFactory::createInstance(OfxImageEffectHandle handle,
