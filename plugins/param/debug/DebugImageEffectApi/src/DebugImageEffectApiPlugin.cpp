...
DebugImageEffectApiPlugin::DebugImageEffectApiPlugin(
...
void
DebugImageEffectApiPlugin::changedParam(const OFX::InstanceChangedArgs &args,
  ...
  if (paramName == kGoTo) {
    ...
    OFX::ImageEffectHostDescription *desc =
    ...
    description << "supportsMultiResolution: " << desc->supportsMultiResolution
                << std::endl;
    description << "supportsTiles: " << desc->supportsTiles << std::endl;
    description << "temporalClipAccess: " << desc->temporalClipAccess
                << std::endl;
    description << "supportsMultipleClipDepths: "
                << desc->supportsMultipleClipDepths << std::endl;
    description << "supportsMultipleClipPARs: "
                << desc->supportsMultipleClipPARs << std::endl;
    description << "supportsSetableFrameRate: "
                << desc->supportsSetableFrameRate << std::endl;
    description << "supportsSetableFielding: " << desc->supportsSetableFielding
                << std::endl;
    description << "supportsStringAnimation: " << desc->supportsStringAnimation
                << std::endl;
    description << "supportsCustomInteract: " << desc->supportsCustomInteract
                << std::endl;
    description << "supportsChoiceAnimation: " << desc->supportsChoiceAnimation
                << std::endl;
    description << "supportsBooleanAnimation: "
                << desc->supportsBooleanAnimation << std::endl;
    description << "supportsCustomAnimation: " << desc->supportsCustomAnimation
                << std::endl;
    ...
    for (OFX::ImageEffectHostDescription::PixelComponentArray::const_iterator
             it = desc->_supportedComponents.begin(),
             itEnd = desc->_supportedComponents.end();
         it != itEnd; ++it)
      description << OFX::mapPixelComponentEnumToString(*it) << ", ";
    description << std::endl;
    description << "_supportedContexts: ";
    for (OFX::ImageEffectHostDescription::ContextArray::const_iterator
             it = desc->_supportedContexts.begin(),
             itEnd = desc->_supportedContexts.end();
         it != itEnd; ++it)
      description << OFX::mapContextEnumToString(*it) << ", ";
    description << std::endl;
    description << "_supportedPixelDepths: ";
    for (OFX::ImageEffectHostDescription::BitDepthArray::const_iterator
             it = desc->_supportedPixelDepths.begin(),
             itEnd = desc->_supportedPixelDepths.end();
         it != itEnd; ++it)
      description << OFX::mapBitDepthEnumToString(*it) << ", ";
    description << std::endl;
    description << "supportsProgressSuite: " << desc->supportsProgressSuite
                << std::endl;
    description << "supportsTimeLineSuite: " << desc->supportsTimeLineSuite
                << std::endl;

    description << "this->timeLineGetTime(): " << this->timeLineGetTime()
                << std::endl;
    double t1 = 0, t2 = 0;
