...
template <class View>
DebugImageEffectApiProcess<View>::DebugImageEffectApiProcess(
    DebugImageEffectApiPlugin &instance)
 ...
 */
template <class View>
void DebugImageEffectApiProcess<View>::multiThreadProcessImages(
