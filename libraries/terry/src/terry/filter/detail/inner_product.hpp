...
template <std::size_t Size> struct inner_product_k_t {
  ...
  GIL_FORCEINLINE static _Tp
  apply(_InputIterator1 __first1, _InputIterator2 __first2, _Tp __init,
...
GIL_FORCEINLINE _Tp
inner_product_k(_InputIterator1 __first1, _InputIterator2 __first2, _Tp __init,
