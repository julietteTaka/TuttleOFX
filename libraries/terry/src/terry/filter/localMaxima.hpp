...
struct pixel_locator_gradientLocalMaxima_t {
  ...
  pixel_locator_gradientLocalMaxima_t(const SView &src)
      : _loc_ref(src.xy_at(0, 0)), LT(_loc_ref.cache_location(-1, -1)),
        CT(_loc_ref.cache_location(0, -1)), RT(_loc_ref.cache_location(1, -1)),
        LC(_loc_ref.cache_location(-1, 0)), RC(_loc_ref.cache_location(1, 0)),
        LB(_loc_ref.cache_location(-1, 1)), CB(_loc_ref.cache_location(0, 1)),
...
void applyLocalMaxima(const SView &srcView, DView &dstView) {
  ...
  terry::algorithm::transform_pixels_locator(
      ...
      getBounds<std::ptrdiff_t>(dstView), getBounds<std::ptrdiff_t>(dstView),
