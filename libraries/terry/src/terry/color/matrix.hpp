...
Matrix5x5 scaleMatrix(const typename Matrix5x5::value_type rScale,
 ...
 */
template <class Matrix5x5>
Matrix5x5 contrastMatrix(const typename Matrix5x5::value_type rScale,
                         const typename Matrix5x5::value_type gScale,
                         const typename Matrix5x5::value_type bScale,
                         const typename Matrix5x5::value_type aScale) {
  Matrix5x5 matrix(5, 5);
 ...
 */
template <class Matrix5x5>
Matrix5x5 offsetMatrix(const typename Matrix5x5::value_type rOffset,
 ...
 */
template <class Matrix5x5>
Matrix5x5 xRotateMatrix(const typename Matrix5x5::value_type rs,
 ...
 */
template <class Matrix5x5>
Matrix5x5 yRotateMatrix(const typename Matrix5x5::value_type rs,
                        const typename Matrix5x5::value_type rc) {
  Matrix5x5 matrix(5, 5);
 ...
 */
template <class Matrix5x5>
Matrix5x5 zRotateMatrix(const typename Matrix5x5::value_type rs,
                        const typename Matrix5x5::value_type rc) {
  Matrix5x5 matrix(5, 5);
 ...
 */
template <class Matrix5x5>
Matrix5x5 zShearMatrix(const typename Matrix5x5::value_type dx,
 ...
 */
template <class Matrix5x5>
void xformpnt(const Matrix5x5 &matrix, const typename Matrix5x5::value_type x,
