...
inline _InIt find_if(_InIt _First, _InIt _Last, _InIt2 _First2, Pred pred) {
...
inline _Fn1 for_each(_InIt _First, _InIt _Last, _InIt2 _First2, _Fn1 _Func) {
  for (; _First != _Last; ++_First, ++_First2)
...
inline _Fn1 for_each(_InIt _First, _InIt _Last, _InIt2 _First2, _InIt3 _First3,
                     _Fn1 _Func) {
...
template <typename _InIt, typename _InIt2, typename _InIt3, typename _InIt4,
          typename _Fn1>
inline _Fn1 for_each(_InIt _First, _InIt _Last, _InIt2 _First2, _InIt3 _First3,
                     _InIt4 _First4, _Fn1 _Func) {
