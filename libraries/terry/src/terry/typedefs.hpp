...
/// \brief 64-bit unsigned integral channel type  (typedef from uint64_t).
...
/// \ingroup ChannelModel
/// \brief 64-bit signed integral channel type (typedef from int64_t). Models
/// ChannelValueConcept
...
typedef bit_aligned_pixel_reference<uint32_t,
                                    ...
                                    rgb_layout_t, true> rgb10_stream_ref_t;
typedef bit_aligned_pixel_iterator<rgb10_stream_ref_t> rgb10_stream_ptr_t;
typedef std::iterator_traits<rgb10_stream_ptr_t>::value_type
...
typedef bit_aligned_pixel_reference<uint64_t,
                                    ...
                                    rgba_layout_t, true> rgba10_stream_ref_t;
typedef bit_aligned_pixel_iterator<rgba10_stream_ref_t> rgba10_stream_ptr_t;
typedef std::iterator_traits<rgba10_stream_ptr_t>::value_type
...
typedef bit_aligned_pixel_reference<uint64_t,
                                    mpl::vector4_c<uint10_t, 10, 10, 10, 10>,
                                    abgr_layout_t, true> abgr10_stream_ref_t;
typedef bit_aligned_pixel_iterator<abgr10_stream_ref_t> abgr10_stream_ptr_t;
typedef std::iterator_traits<abgr10_stream_ptr_t>::value_type
...
typedef bit_aligned_pixel_reference<uint64_t,
                                    ...
                                    rgb_layout_t, true> rgb12_stream_ref_t;
typedef bit_aligned_pixel_iterator<rgb12_stream_ref_t> rgb12_stream_ptr_t;
typedef std::iterator_traits<rgb12_stream_ptr_t>::value_type
...
typedef bit_aligned_pixel_reference<uint64_t,
                                    ...
                                    rgba_layout_t, true> rgba12_stream_ref_t;
typedef bit_aligned_pixel_iterator<rgba12_stream_ref_t> rgba12_stream_ptr_t;
typedef std::iterator_traits<rgba12_stream_ptr_t>::value_type
...
typedef bit_aligned_pixel_reference<uint64_t,
                                    mpl::vector4_c<uint12_t, 12, 12, 12, 12>,
                                    abgr_layout_t, true> abgr12_stream_ref_t;
typedef bit_aligned_pixel_iterator<abgr12_stream_ref_t> abgr12_stream_ptr_t;
typedef std::iterator_traits<abgr12_stream_ptr_t>::value_type
...
typedef const packed_channel_reference<uint64_t, 52, 12, true>
rgba12_packed_channel3_t;
typedef mpl::vector4<rgba12_packed_channel0_t, rgba12_packed_channel1_t,
                     rgba12_packed_channel2_t,
                     rgba12_packed_channel3_t> rgba12_packed_channels_t;
typedef packed_pixel<uint64_t, rgba12_packed_channels_t, rgba_layout_t>
...
typedef mpl::vector4<abgr12_packed_channel0_t, abgr12_packed_channel1_t,
                     abgr12_packed_channel2_t,
                     abgr12_packed_channel3_t> abgr12_packed_channels_t;
typedef packed_pixel<uint64_t, abgr12_packed_channels_t, abgr_layout_t>
...
typedef const packed_channel_reference<uint32_t, 22, 10, true>
rgb10_packed_channel0_t;
typedef const packed_channel_reference<uint32_t, 12, 10, true>
rgb10_packed_channel1_t;
typedef const packed_channel_reference<uint32_t, 02, 10, true>
rgb10_packed_channel2_t;
typedef mpl::vector3<rgb10_packed_channel0_t, rgb10_packed_channel1_t,
                     rgb10_packed_channel2_t> rgb10_packed_channels_t;
typedef packed_pixel<uint32_t, rgb10_packed_channels_t, rgb_layout_t>
...
typedef const packed_channel_reference<uint64_t, 22, 10, true>
rgba10_packed_channel0_t;
typedef const packed_channel_reference<uint64_t, 12, 10, true>
rgba10_packed_channel1_t;
typedef const packed_channel_reference<uint64_t, 02, 10, true>
rgba10_packed_channel2_t;
typedef const packed_channel_reference<uint64_t, 54, 10, true>
rgba10_packed_channel3_t;
typedef mpl::vector4<rgba10_packed_channel0_t, rgba10_packed_channel1_t,
                     rgba10_packed_channel2_t,
                     rgba10_packed_channel3_t> rgba10_packed_channels_t;
typedef packed_pixel<uint64_t, rgba10_packed_channels_t, rgba_layout_t>
...
typedef const packed_channel_reference<uint64_t, 4, 10, true>
abgr10_packed_channel0_t;
typedef const packed_channel_reference<uint64_t, 20, 10, true>
abgr10_packed_channel1_t;
typedef const packed_channel_reference<uint64_t, 36, 10, true>
abgr10_packed_channel2_t;
typedef const packed_channel_reference<uint64_t, 52, 10, true>
abgr10_packed_channel3_t;
typedef mpl::vector4<abgr10_packed_channel0_t, abgr10_packed_channel1_t,
                     abgr10_packed_channel2_t,
                     abgr10_packed_channel3_t> abgr10_packed_channels_t;
typedef packed_pixel<uint64_t, abgr10_packed_channels_t, abgr_layout_t>
