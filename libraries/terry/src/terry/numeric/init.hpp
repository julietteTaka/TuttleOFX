...
template <typename Pixel> GIL_FORCEINLINE Pixel &pixel_zeros(Pixel &p) {
  return pixel_zeros_t<Pixel>()(p);
}

template <typename Pixel> GIL_FORCEINLINE Pixel pixel_zeros() {
  Pixel p;
  return pixel_zeros_t<Pixel>()(p);
}
...
template <typename Pixel> GIL_FORCEINLINE Pixel &pixel_ones(Pixel &p) {
  return pixel_ones_t<Pixel>()(p);
}

template <typename Pixel> GIL_FORCEINLINE Pixel pixel_ones() {
  Pixel p;
  return pixel_ones_t<Pixel>()(p);
}
}
