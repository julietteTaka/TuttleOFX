...
/// \brief for image views (passes locators to the function object, instead of
/// pixel references)
////////////////////////////////////////////////////////////////////////////////
...
template <typename View, typename F>
GIL_FORCEINLINE F
transform_pixels_locator(const View &dst, const Rect<std::ptrdiff_t> &dstRod,
...
GIL_FORCEINLINE F
transform_pixels_locator(const View &src, const Rect<std::ptrdiff_t> &srcRod,
...
GIL_FORCEINLINE F
transform_pixels_locator(const View1 &src1, const Rect<std::ptrdiff_t> &src1Rod,
