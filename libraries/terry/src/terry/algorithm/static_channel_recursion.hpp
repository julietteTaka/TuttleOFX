...
template <int N> struct element_recursion {
  ...
  static Op static_for_each(P1 &p1, P2 &p2, P3 &p3, const P4 &p4, Op op) {
    ...
    op2(semantic_at_c<N - 1>(p1), semantic_at_c<N - 1>(p2),
        semantic_at_c<N - 1>(p3), semantic_at_c<N - 1>(p4));
    return op2;
  }
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  ...
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  static Op static_for_each(P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4,
                            Op op) {
    Op op2(element_recursion<N - 1>::static_for_each(p1, p2, p3, p4, op));
    op2(semantic_at_c<N - 1>(p1), semantic_at_c<N - 1>(p2),
        semantic_at_c<N - 1>(p3), semantic_at_c<N - 1>(p4));
  ...
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  static Op static_for_each(const P1 &p1, P2 &p2, const P3 &p3, const P4 &p4,
                            Op op) {
    Op op2(element_recursion<N - 1>::static_for_each(p1, p2, p3, p4, op));
    op2(semantic_at_c<N - 1>(p1), semantic_at_c<N - 1>(p2),
        semantic_at_c<N - 1>(p3), semantic_at_c<N - 1>(p4));
  ...
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  static Op static_for_each(const P1 &p1, const P2 &p2, P3 &p3, const P4 &p4,
                            Op op) {
    Op op2(element_recursion<N - 1>::static_for_each(p1, p2, p3, p4, op));
    op2(semantic_at_c<N - 1>(p1), semantic_at_c<N - 1>(p2),
        semantic_at_c<N - 1>(p3), semantic_at_c<N - 1>(p4));
  ...
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  static Op static_for_each(const P1 &p1, const P2 &p2, const P3 &p3,
                            const P4 &p4, Op op) {
    Op op2(element_recursion<N - 1>::static_for_each(p1, p2, p3, p4, op));
    op2(semantic_at_c<N - 1>(p1), semantic_at_c<N - 1>(p2),
        semantic_at_c<N - 1>(p3), semantic_at_c<N - 1>(p4));
  ...
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  static Op static_for_each(const P1 &p1, const P2 &p2, const P3 &p3, P4 &p4,
                            Op op) {
    Op op2(element_recursion<N - 1>::static_for_each(p1, p2, p3, p4, op));
    op2(semantic_at_c<N - 1>(p1), semantic_at_c<N - 1>(p2),
        semantic_at_c<N - 1>(p3), semantic_at_c<N - 1>(p4));
  ...
  //    }
  //    template <typename P1,typename P2,typename Dst,typename Op>
  //    static Op static_transform(const P1& src1, const P2& src2, Dst& dst, Op
  // op) {
  //        Op op2(element_recursion<N-1>::static_transform(src1,src2,dst,op));
  //        semantic_at_c<N-1>(dst)=op2(semantic_at_c<N-1>(src1),
  // semantic_at_c<N-1>(src2));
...
template <> struct element_recursion<0> {
  // static_for_each with four sources
  template <typename P1, typename P2, typename P3, typename P4, typename Op>
  static Op static_for_each(const P1 &, const P2 &, const P3 &, const P4 &,
                            Op op) {
    return op;
  }
  ...
  static Op static_transform(const P1 &, const P2 &, const P3 &, const Dst &,
                             Op op) {
    return op;
  }
};
...
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, P2 &p2, P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, P2 &p2, const P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, const P2 &p2, P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, P2 &p2, P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, P2 &p2, const P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, const P2 &p2, P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
...
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, P2 &p2, const P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, const P2 &p2, P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(P1 &p1, const P2 &p2, const P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, P2 &p2, P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, P2 &p2, const P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, const P2 &p2, P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
template <typename P1, typename P2, typename P3, typename P4, typename Op>
GIL_FORCEINLINE Op
static_for_each(const P1 &p1, const P2 &p2, const P3 &p3, P4 &p4, Op op) {
  return ext_detail::element_recursion<size<P1>::value>::static_for_each(
      p1, p2, p3, p4, op);
}
///\}
