...
/**
 * @brief Set each pixel in the destination view as the result of a color
transformation over the source view
                ...
                tuttle::plugin::IProgress* p )
{
        for( int y = 0; y < src_view.height(); ++y )
        {
                ...
                {
                        // *dst_it = *src_it;
                        colorSpaceAPI->colorspace_convert( eGradationLawIn,
eLayoutIn, eTempIn, eGradationLawOut, eLayoutOut, eTempOut , *src_it , *dst_it
);
                }
