...
Host::Host() {
  ...
  _properties.setIntProperty(kOfxImageEffectPropSupportsTiles,
                             true); ///< @todo tuttle: we hope to do this !
  ...
  _properties.setStringProperty(kOfxImageEffectPropSupportedComponents,
                                kOfxImageComponentRGB, 1);
  _properties.setStringProperty(kOfxImageEffectPropSupportedComponents,
                                kOfxImageComponentAlpha, 2);
  _properties.setStringProperty(kOfxImageEffectPropSupportedContexts,
                                kOfxImageEffectContextFilter, 0);
  _properties.setStringProperty(kOfxImageEffectPropSupportedContexts,
                                kOfxImageEffectContextGenerator, 1);
  _properties.setStringProperty(kOfxImageEffectPropSupportedContexts,
                                kOfxImageEffectContextRetimer, 2);
  _properties.setStringProperty(kOfxImageEffectPropSupportedContexts,
                                kOfxImageEffectContextTransition, 3);
  _properties.setStringProperty(kOfxImageEffectPropSupportedContexts,
                                kOfxImageEffectContextGeneral, 4);
  //	_properties.setStringProperty( kOfxImageEffectPropSupportedContexts,
  //kOfxImageEffectContextReader, 5 );
  //	_properties.setStringProperty( kOfxImageEffectPropSupportedContexts,
  //kOfxImageEffectContextWriter, 6 );
  _properties.setStringProperty(kOfxImageEffectPropSupportedPixelDepths,
                                kOfxBitDepthFloat, 0);
  _properties.setStringProperty(kOfxImageEffectPropSupportedPixelDepths,
                                kOfxBitDepthShort, 1);
  _properties.setStringProperty(kOfxImageEffectPropSupportedPixelDepths,
                                kOfxBitDepthByte, 2);
  _properties.setIntProperty(kOfxImageEffectPropSupportsMultipleClipDepths,
                             true);
...
tuttle::host::ImageEffectNode *Host::newInstance(
...
Host::makeDescriptor(
    const tuttle::host::ofx::imageEffect::OfxhImageEffectNodeDescriptor &
        rootContext,
    tuttle::host::ofx::imageEffect::OfxhImageEffectPlugin &plugin) const {
  return new tuttle::host::ofx::imageEffect::OfxhImageEffectNodeDescriptor(
      rootContext, plugin);
}
...
/// message
OfxStatus Host::vmessage(const char *type, const char *id, const char *format,
                         va_list args) const {
  ...
  if (isQuestion) {
    /// cant do this properly inour example, as we need to raise a dialogue to
    /// ask a question, so just return yes
