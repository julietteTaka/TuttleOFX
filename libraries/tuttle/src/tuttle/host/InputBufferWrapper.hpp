...
public:
  ...
  typedef void (*CallbackInputImagePtr)(OfxTime time,
                                        CustomDataPtr outputCustomData,
                                        void **rawdata, int *width, int *height,
                                        int *rowSizeBytes);
...
public:
  InputBufferWrapper(INode &node) : _node(&node) {}
  InputBufferWrapper() : _node(NULL) {}
  ~InputBufferWrapper() {}
...
private:
  ...
  void set3DArrayBuffer(void *rawBuffer, const int width, const int height,
...
public:
  ...
  void set3DArrayBuffer(unsigned char *rawBuffer, int height, int width,
                        int nbComponents) {
  ...
  void set3DArrayBuffer(unsigned short *rawBuffer, int height, int width,
                        int nbComponents) {
    set3DArrayBuffer((void *)rawBuffer, width, height, nbComponents);
    setBitDepth(eBitDepthUShort);
  }
  ...
  void set3DArrayBuffer(float *rawBuffer, int height, int width,
                        int nbComponents) {
    set3DArrayBuffer((void *)rawBuffer, width, height, nbComponents);
    setBitDepth(eBitDepthUShort);
  }
  ...
  void setRawImageBuffer(void *rawBuffer, const int width, const int height,
  ...
  void setRawImageBuffer(unsigned char *rawBuffer, const int width,
                         const int height, const EPixelComponent components,
                         const int rowDistanceBytes = 0,
                         const EImageOrientation orientation =
                             eImageOrientationFromBottomToTop) {
    setRawImageBuffer(reinterpret_cast<void *>(rawBuffer), width, height,
                      components, eBitDepthUByte, rowDistanceBytes,
                      orientation);
  }

  void setRawImageBuffer(unsigned short *rawBuffer, const int width,
                         const int height, const EPixelComponent components,
                         const int rowDistanceBytes = 0,
                         const EImageOrientation orientation =
                             eImageOrientationFromBottomToTop) {
    setRawImageBuffer(reinterpret_cast<void *>(rawBuffer), width, height,
                      components, eBitDepthUShort, rowDistanceBytes,
                      orientation);
  }

  void setRawImageBuffer(float *rawBuffer, const int width, const int height,
                         const EPixelComponent components,
                         const int rowDistanceBytes = 0,
                         const EImageOrientation orientation =
                             eImageOrientationFromBottomToTop) {
    setRawImageBuffer(reinterpret_cast<void *>(rawBuffer), width, height,
                      components, eBitDepthFloat, rowDistanceBytes,
                      orientation);
  }

  void setCallback(CallbackInputImagePtr callback,
