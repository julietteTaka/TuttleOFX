...
void ParamDouble3D::getValue(double &x, double &y, double &z) const
    OFX_EXCEPTION_SPEC {
...
void ParamDouble3D::getValueAtTime(const OfxTime time, double &x, double &y,
                                   double &z) const OFX_EXCEPTION_SPEC {
...
void ParamDouble3D::setValueAtTime(
    const OfxTime time, const double &x, const double &y, const double &z,
