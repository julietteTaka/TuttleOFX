...
ParamRGB::ParamRGB(INode &effect, const std::string &name,
...
void ParamRGB::getValue(double &r, double &g, double &b) const
    OFX_EXCEPTION_SPEC {
...
void ParamRGB::getValueAtTime(const OfxTime time, double &r, double &g,
                              double &b) const OFX_EXCEPTION_SPEC {
...
void
ParamRGB::setValue(const double &r, const double &g, const double &b,
