...
ParamString::ParamString(INode &effect, const std::string &name,
...
void ParamString::getValueAtTime(const OfxTime time, std::string &v) const
    OFX_EXCEPTION_SPEC {
  v = _value; ///< @todo: in time !
}

void
ParamString::setValue(const std::string &v,
...
void ParamString::setValueFromExpression(const std::string &value,
                                         const ofx::attribute::EChange change)
    OFX_EXCEPTION_SPEC {
