...
class ParamDoubleMultiDim
    : public ofx::attribute::OfxhMultiDimParam<ParamDouble, DIM> {
public:
  typedef ofx::attribute::OfxhMultiDimParam<ParamDouble, DIM>
  MultiDimParamParent;

  ParamDoubleMultiDim(const ofx::attribute::OfxhParamDescriptor &descriptor,
