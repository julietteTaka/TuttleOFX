...
ParamInteger3D::ParamInteger3D(
    INode &effect, const std::string &name,
    const ofx::attribute::OfxhParamDescriptor &descriptor)
    : Param(effect), ofx::attribute::OfxhMultiDimParam<ParamInteger, 3>(
...
void ParamInteger3D::getValueAtTime(const OfxTime time, int &x, int &y,
                                    int &z) const OFX_EXCEPTION_SPEC {
...
void ParamInteger3D::setValueAtTime(
    const OfxTime time, const int &x, const int &y, const int &z,
