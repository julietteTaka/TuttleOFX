...
ParamRGBA::ParamRGBA(INode &effect, const std::string &name,
...
void ParamRGBA::getValue(double &r, double &g, double &b, double &a) const
    OFX_EXCEPTION_SPEC {
...
void ParamRGBA::getValueAtTime(const OfxTime time, double &r, double &g,
                               double &b, double &a) const OFX_EXCEPTION_SPEC {
...
void ParamRGBA::setValue(const double &r, const double &g, const double &b,
                         const double &a, const ofx::attribute::EChange change)
    OFX_EXCEPTION_SPEC {
...
void ParamRGBA::setValueAtTime(
    const OfxTime time, const double &r, const double &g, const double &b,
    const double &a, const ofx::attribute::EChange change) OFX_EXCEPTION_SPEC {
