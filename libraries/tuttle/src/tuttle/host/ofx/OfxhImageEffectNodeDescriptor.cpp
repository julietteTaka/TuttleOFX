    ...
    [] =
        {
          ...
          { kOfxPropPluginDescription, property::ePropTypeString, 1,
            false,                     "No plugin description." },
          { kOfxImageEffectPropSupportedContexts, property::ePropTypeString, 0,
            false,                                "" },
          { kOfxImageEffectPluginPropGrouping, property::ePropTypeString, 1,
            false,                             "" },
          { kOfxImageEffectPluginPropSingleInstance, property::ePropTypeInt, 1,
            false,                                   "0" },
          { kOfxImageEffectPluginRenderThreadSafety, property::ePropTypeString,
            1,                                       false,
            kOfxImageEffectRenderInstanceSafe },
          { kOfxImageEffectPluginPropHostFrameThreading, property::ePropTypeInt,
            1,                                           false,
            "1" },
          { kOfxImageEffectPluginPropOverlayInteractV1,
            property::ePropTypePointer,
            1,
            false,
            NULL },
          { kOfxImageEffectPropSupportsMultiResolution, property::ePropTypeInt,
            1,                                          false,
            "1" },
          { kOfxImageEffectPropSupportsTiles, property::ePropTypeInt, 1,
            false,                            "1" },
          { kOfxImageEffectPropTemporalClipAccess, property::ePropTypeInt, 1,
            false,                                 "0" },
          { kOfxImageEffectPropSupportedPixelDepths, property::ePropTypeString,
            0,                                       false,
            "" },
          ...
          { kOfxImageEffectPropSupportsMultipleClipDepths,
            ...
            false,
            "0" },
          { kOfxImageEffectPropSupportsMultipleClipPARs, property::ePropTypeInt,
            1,                                           false,
            "0" },
...
OfxhImageEffectNodeDescriptor::OfxhImageEffectNodeDescriptor()
    : OfxhImageEffectNodeBase(effectDescriptorStuff), _plugin(NULL) {
  /// @todo tuttle...
}

OfxhImageEffectNodeDescriptor::OfxhImageEffectNodeDescriptor(OfxhPlugin &plug)
    : OfxhImageEffectNodeBase(effectDescriptorStuff), _plugin(&plug) {
  _properties.setStringProperty(kOfxPluginPropFilePath,
                                plug.getBinary().getBundlePath());
  tuttle::host::core().getHost().initDescriptor(*this);
}

OfxhImageEffectNodeDescriptor::OfxhImageEffectNodeDescriptor(
    const OfxhImageEffectNodeDescriptor &other, OfxhPlugin &plug)
    : OfxhImageEffectNodeBase(other._properties), _plugin(&plug) {
  _properties.setStringProperty(kOfxPluginPropFilePath,
                                plug.getBinary().getBundlePath());
  tuttle::host::core().getHost().initDescriptor(*this);
}
...
OfxhImageEffectNodeDescriptor::OfxhImageEffectNodeDescriptor(
    const std::string &bundlePath, OfxhPlugin &plug)
    : OfxhImageEffectNodeBase(effectDescriptorStuff), _plugin(&plug) {
...
OfxhImageEffectNodeDescriptor::defineClip(const std::string &name) {
  attribute::OfxhClipImageDescriptor *c =
      new attribute::OfxhClipImageDescriptor(name);
...
void
OfxhImageEffectNodeDescriptor::initOverlayDescriptor(int bitDepthPerComponent,
                                                     bool hasAlpha) {
...
void OfxhImageEffectNodeDescriptor::addClip(
    const std::string &name, attribute::OfxhClipImageDescriptor *clip) {
  _clips[name] = clip;
