...
public:
  ...
  typedef std::map<std::string, attribute::OfxhClipImageDescriptor *>
  ClipImageDescriptorMap;
  typedef boost::ptr_vector<attribute::OfxhClipImageDescriptor>
...
protected:
  ...
  ClipImageDescriptorVector _clipsByOrder; ///< clip descriptors in order of
                                           ///declaration
  mutable interact::OfxhInteractDescriptor _overlayDescriptor; ///< descriptor
                                                               ///to use for
                                                               ///overlays, it
                                                               ///has delayed
                                                               ///description
...
private:
  ...
  OfxhImageEffectNodeDescriptor(const OfxhImageEffectNodeDescriptor &other)
      : OfxhImageEffectNodeBase(other._properties), _plugin(other._plugin) {}
...
public:
  ...
  OfxhImageEffectNodeDescriptor(
      const OfxhImageEffectNodeDescriptor &rootContext, OfxhPlugin &plug);

  /// used to construct populate the cache
  OfxhImageEffectNodeDescriptor(const std::string &bundlePath,
                                OfxhPlugin &plug);
  ...
  virtual attribute::OfxhClipImageDescriptor *
