...
bool findType(const std::string paramType, property::EPropType &propType,
              int &propDim) {
  TypeMap *tm = typeMap;
 ...
 */
OfxhParamDescriptor::OfxhParamDescriptor(const std::string &type,
  ...
  const property::OfxhPropSpec dynamicParamDescriptorProps
      [] = { { kOfxParamPropType, property::ePropTypeString, 1, true, ctype },
             { kOfxParamPropScriptName, property::ePropTypeString, 1,
               false,                   cname }, ///< @todo TUTTLE_TODO : common
                                                 ///property for all Attributes
             { 0 } };
...
void OfxhParamDescriptor::initStandardParamProps(const std::string &type) {
  ...
  if (type == kOfxParamTypeString) {
    static const property::OfxhPropSpec allString[] =
        { { kOfxParamPropStringMode, property::ePropTypeString,  1,
            false,                   kOfxParamStringIsSingleLine },
          { kOfxParamPropStringFilePathExists, property::ePropTypeInt, 1,
            false,                             "1" },
          { 0 } };
  ...
  if (type == kOfxParamTypeChoice) {
    static const property::OfxhPropSpec allChoice
        [] = { { kOfxParamPropChoiceOption, property::ePropTypeString, 0,
                 false,                     "" },
               { kOfxParamPropChoiceLabelOption, property::ePropTypeString, 0,
                 false,                          "" },
               { 0 } };
    ...
    static const property::OfxhPropSpec allCustom[] = {
      { kOfxParamPropCustomInterpCallbackV1, property::ePropTypePointer, 1,
        false,                               0 },
      { 0 },
    };
...
void OfxhParamDescriptor::initInteractParamProps(const std::string &type) {
  static const property::OfxhPropSpec allButGroupPageProps[] =
      { { kOfxParamPropInteractV1, property::ePropTypePointer, 1, false, 0 },
        ...
        { kOfxParamPropInteractSizeAspect, property::ePropTypeDouble, 1,
          false,                           "1" },
        { kOfxParamPropInteractMinimumSize, property::ePropTypeInt, 2,
          false,                            "10" },
        { kOfxParamPropInteractPreferedSize, property::ePropTypeInt, 2,
          false,                             "10" },
        { 0 } };
 ...
 */
void OfxhParamDescriptor::initValueParamProps(const std::string &type,
  ...
  static const property::OfxhPropSpec invariantProps[] = {
    ...
    { kOfxParamPropCacheInvalidation, property::ePropTypeString,     1,
      false,                          kOfxParamInvalidateValueChange },
    { 0 }
  };

  property::OfxhPropSpec variantProps[] = {
    { kOfxParamPropDefault,                             valueType, dim, false,
      valueType == property::ePropTypeString ? "" : "0" },
    { 0 }
  };
 ...
 * add standard properties to a value holding param
 */
void OfxhParamDescriptor::initNumericParamProps(const std::string &type,
                                                property::EPropType valueType,
                                                int dim) {
  ...
  property::OfxhPropSpec allNumeric[] =
      { { kOfxParamPropDisplayMin, valueType, dim, false,
          isColourParam(type) ? "0" : (valueType == property::ePropTypeDouble
                                           ? dbl_minstr
                                           : int_minstr).c_str() },
        { kOfxParamPropDisplayMax, valueType, dim, false,
          isColourParam(type) ? "1" : (valueType == property::ePropTypeDouble
                                           ? dbl_maxstr
                                           : int_maxstr).c_str() },
        { kOfxParamPropMin, valueType, dim, false,
          (valueType == property::ePropTypeDouble ? dbl_minstr : int_minstr)
              .c_str() },
        { kOfxParamPropMax, valueType, dim, false,
          (valueType == property::ePropTypeDouble ? dbl_maxstr : int_maxstr)
              .c_str() },
        { 0 } };
  ...
  if (valueType == property::ePropTypeDouble) {
    static const property::OfxhPropSpec allDouble[] = {
      ...
      { kOfxParamPropDigits, property::ePropTypeInt, 1, false, "2" }, { 0 }
    };
  ...
  if (isDoubleParam(type)) {
    static const property::OfxhPropSpec allDouble[] = {
      { kOfxParamPropDoubleType, property::ePropTypeString, 1,
        false,                   kOfxParamDoubleTypePlain },
      { 0 }
    };
    getEditableProperties().addProperties(allDouble);
  ...
  if (isDoubleParam(type) && (dim == 2 || dim == 3)) {
    property::OfxhPropSpec all2D3D[] = { { kOfxParamPropDimensionLabel,
                                           property::ePropTypeString,
                                           dim,
                                           false,
                                           "" },
                                         { 0 }, };
    ...
    getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel, "X",
                                              0);
    getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel, "Y",
                                              1);
    if (dim == 3) {
      getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel,
                                                "Z", 2);
    }
  }
  ...
  if (isColourParam(type)) {
    property::OfxhPropSpec allColor[] = { { kOfxParamPropDimensionLabel,
                                            property::ePropTypeString,
                                            dim,
                                            false,
                                            "" },
    ...
    getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel, "R",
                                              0);
    getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel, "G",
                                              1);
    getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel, "B",
                                              2);
    if (dim == 4) {
      getEditableProperties().setStringProperty(kOfxParamPropDimensionLabel,
                                                "A", 3);
