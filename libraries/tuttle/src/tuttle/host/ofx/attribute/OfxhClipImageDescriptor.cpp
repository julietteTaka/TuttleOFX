...
void OfxhClipImageDescriptor::init(const std::string &name) {
  ...
  static const property::OfxhPropSpec clipImageDescriptorStuffs[] = {
    ...
    { kOfxImageEffectPropSupportedComponents, property::ePropTypeString, 0,
      false,                                  "" },
    { kOfxImageEffectPropTemporalClipAccess, property::ePropTypeInt, 1,
      false,                                 "0" },
    { kOfxImageClipPropIsMask, property::ePropTypeInt, 1, false, "0" },
    { kOfxImageClipPropFieldExtraction, property::ePropTypeString, 1,
      false,                            kOfxImageFieldDoubled },
