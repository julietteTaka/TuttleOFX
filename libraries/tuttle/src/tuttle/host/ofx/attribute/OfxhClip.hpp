...
public:
  ...
  void notify(const std::string &name, bool isSingle,
 ...
 */
inline OfxhClip *new_clone(const OfxhClip &a) { return a.clone(); }
...
struct is_virtual_base_of<
    ...
    tuttle::host::ofx::attribute::OfxhClip> : public mpl::true_ {};
}
