...
class OfxhParamDescriptor : public OfxhAttributeDescriptor,
...
private:
  ...
  void initValueParamProps(const std::string &type,
                           property::EPropType valueType, int dim);
  void initNoValueParamProps();

  /// add standard properties to a value holding param
  void initNumericParamProps(const std::string &type,
                             property::EPropType valueType, int dim);
