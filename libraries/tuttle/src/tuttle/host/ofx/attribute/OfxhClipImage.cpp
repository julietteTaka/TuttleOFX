      ...
      //				, _components( kOfxImageComponentNone )
{
  ...
  static property::OfxhPropSpec clipImageInstanceStuffs
      [] = { { kOfxImageEffectPropPixelDepth, property::ePropTypeString, 1,
             ...
             { kOfxImageClipPropUnmappedPixelDepth, property::ePropTypeString,
               1,                                   true,
               kOfxBitDepthNone },
             { kOfxImageClipPropUnmappedComponents, property::ePropTypeString,
               1,                                   true,
               kOfxImageComponentNone },
             { kOfxImageEffectPropPreMultiplication, property::ePropTypeString,
               1,                                    true,
               kOfxImageOpaque },
             { kOfxImagePropPixelAspectRatio, property::ePropTypeDouble, 1,
               true,                          "1.0" },
             { kOfxImageEffectPropFrameRate, property::ePropTypeDouble, 1,
               true,                         "25.0" },
             { kOfxImageEffectPropFrameRange, property::ePropTypeDouble, 2,
               true,                          "0" },
             { kOfxImageClipPropFieldOrder, property::ePropTypeString, 1,
               true,                        kOfxImageFieldNone },
             { kOfxImageEffectPropUnmappedFrameRange, property::ePropTypeDouble,
               2,                                     true,
               "0" },
             { kOfxImageEffectPropUnmappedFrameRate, property::ePropTypeDouble,
               1,                                    true,
               "25.0" },
...
const std::string &
OfxhClipImage::findSupportedComp(const std::string &s) const {
  ...
  //	/// were we fed some custom non chromatic component by
  //getUnmappedComponents? Return it.
  ...
  /// wierd, must be some custom bit , if only one, choose that, otherwise no
  /// idea
