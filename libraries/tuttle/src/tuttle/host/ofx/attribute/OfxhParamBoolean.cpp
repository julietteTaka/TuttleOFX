 ...
 * implementation of var args function
 */
void OfxhParamBoolean::getV(const OfxTime time, va_list arg) const
    OFX_EXCEPTION_SPEC {
  bool v;
 ...
 * implementation of var args function
 */
void OfxhParamBoolean::setV(va_list arg,
 ...
 * implementation of var args function
 */
void OfxhParamBoolean::setV(const OfxTime time, va_list arg,
                            const EChange change) OFX_EXCEPTION_SPEC {
  bool value = va_arg(arg, int)!= 0;
