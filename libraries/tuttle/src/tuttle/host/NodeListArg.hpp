...
/**
 * @brief An utility class to use as function argument. It allows to create a
 *list of nodes from multiple inputs.
 *
...
public:
  NodeListArg() {}
  NodeListArg(const std::list<std::string> &nodes) : _nodes(nodes) {}
