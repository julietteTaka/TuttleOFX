...
ImageGilFilterProcessor<SView, DView>::ImageGilFilterProcessor(
    OFX::ImageEffect &effect, const EImageOrientation imageOrientation)
...
template <class SView, class DView>
void
ImageGilFilterProcessor<SView, DView>::setup(const OFX::RenderArguments &args) {
  ...
  _srcView = ImageGilProcessor<DView>::template getCustomView<SView>(
