...
public:
  IsEnableParamFunctor(OFX::Param *param) : _param(param) {}
...
public:
  IsNotSecretParamFunctor(OFX::Param *param) : _param(param) {}
...
public:
  IsActiveBooleanParamFunctor(OFX::BooleanParam *param) : _param(param) {}
...
public:
  IsActiveChoiceParamFunctor(OFX::ChoiceParam *param) : _param(param) {}

  bool active() const { return _param->getValue() != negate; }
  This *clone() const { return new This(*this); }
};

template <bool negate = false> class AndActiveFunctor : public IsActiveFunctor {
  typedef AndActiveFunctor<negate> This;
  boost::ptr_vector<IsActiveFunctor> _list;

public:
  void push_back(IsActiveFunctor *f) { _list.push_back(f); }
...
template <bool negate = false> class OrActiveFunctor : public IsActiveFunctor {
