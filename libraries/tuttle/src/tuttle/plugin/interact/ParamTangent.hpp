...
public:
  ...
  ParamTangent(const InteractInfos &infos, OFX::Double2DParam *pCenter,
               OFX::Double2DParam *pTanA, OFX::Double2DParam *pTanB,
               const TFrame &frame)
      : Parent(infos, pCenter, frame), _paramTanA(infos, pTanA, frame),
        _paramTanB(infos, pTanB, frame), _selectType(eSelectTypeNone) {}
