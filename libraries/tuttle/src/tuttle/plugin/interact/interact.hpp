...
inline EAxis clicPoint(const Point &point, const Point &mouse,
                       const double marge) {
  Point dist;
 ...
 */
inline EAxis clicDouble2D(const OFX::Double2DParam &point,
                          const OfxPointD &mouse, const double marge) {
