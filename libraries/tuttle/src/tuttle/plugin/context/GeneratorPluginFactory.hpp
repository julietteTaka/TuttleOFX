...
void describeGeneratorParamsInContext(OFX::ImageEffectDescriptor &desc,
  ...
  OFX::ChoiceParamDescriptor *explicitConversion =
  ...
  if (OFX::getImageEffectHostDescription()->supportsMultipleClipDepths) {
    ...
    explicitConversion->setDefault(static_cast<int>(
        OFX::getImageEffectHostDescription()->getPixelDepth()));
  }
  ...
  OFX::BooleanParamDescriptor *specificRatio =
      desc.defineBooleanParam(kParamSizeSpecificRatio);
  ...
  OFX::DoubleParamDescriptor *ratioValue =
      desc.defineDoubleParam(kParamSizeRatioValue);
