...
void ReaderPlugin::changedParam(const OFX::InstanceChangedArgs &args,
...
void
ReaderPlugin::getClipPreferences(OFX::ClipPreferencesSetter &clipPreferences) {
...
bool ReaderPlugin::getTimeDomain(OfxRangeD &range) {
  ...
  TUTTLE_TLOG(TUTTLE_INFO, "[Reader plugin] Time Domain : "
