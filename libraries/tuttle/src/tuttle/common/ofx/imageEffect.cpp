...
const std::string mapContextEnumToString(const EContext s) {
  ...
  BOOST_THROW_EXCEPTION(exception::Value()
                        << exception::dev() +
                               "Unknown image effect context enum.");
  return "";
}

// const std::string mapMessageTypeEnumToString( const
// OFX::Message::EMessageType type )
//{
...
//
///** @brief map a std::string to a context */
// InstanceChangeReason mapInstanceChangedReasonStringToEnum( const std::string&
// s )
//{
