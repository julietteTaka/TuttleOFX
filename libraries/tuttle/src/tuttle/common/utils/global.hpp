...
#define TUTTLE_LOG_WARNING(...)                                                \
  BOOST_LOG_TRIVIAL(warning) << tuttle::common::Color::get()->_yellow          \
                             << __VA_ARGS__                                    \
                             << tuttle::common::Color::get()->_std
#define TUTTLE_LOG_ERROR(...)                                                  \
  BOOST_LOG_TRIVIAL(error) << tuttle::common::Color::get()->_error             \
                           << __VA_ARGS__                                      \
                           << tuttle::common::Color::get()->_std
#define TUTTLE_LOG_FATAL(...)                                                  \
  BOOST_LOG_TRIVIAL(fatal) << tuttle::common::Color::get()->_error             \
                           << __VA_ARGS__                                      \
                           << tuttle::common::Color::get()->_std
...
#define TUTTLE_LOG_VAR3(MODE, a, b, c)                                         \
...
////////////////////////////////////////////////////////////////////////////////
// TUTTLE_TLOG* defines are used by developers for temporary displays during
// development stages.
