...
/**
 * @brief StaticSingleton<ClassStaticSingleton> Can transform a class into
 *static Singleton (by inheriting this class)
 *
 * @par Purpose
 * Forcing (limit) the presence of a single instance of a class
 *
 * @par Usage
 * The class T, to use as static Singleton, must derive from this class (:
 *public StaticSingleton <T>).
 * The macro MAKE_StaticSingleton(T) create necessary elements (including
 *constructors).
 */
