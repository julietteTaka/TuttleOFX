...
/**
 * @brief Singleton<ClassSingleton> Can transform a class into Singleton (by
 ...
 *
 * @par Usage
 * The class T, to use as Singleton, must derive from this class (: public
 *Singleton <T>).
 * The macro MAKE_SINGLETON (T) create necessary elements (including
 *constructors).
 */
