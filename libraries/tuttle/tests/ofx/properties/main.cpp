...
#define testInt_4_ro "testInt_4_ro"
  ...
  static const ofx::property::OfxhPropSpec testStuff[] =
      {
        /* name                                 type                   dim.
           r/o    default value */
        { testString_1_ro, ofx::property::ePropTypeString, 1,
          true,            "default_value" },
        { testString_2_rw, ofx::property::ePropTypeString, 2,
          false,           "default_value" },
  ...
  BOOST_CHECK_EQUAL(testSet.getStringProperty(testString_2_rw, 0),
                    "default_value");
  BOOST_CHECK_EQUAL(testSet.getStringProperty(testString_2_rw, 1),
                    "default_value");
  ...
  for (unsigned int i = 0; i < 2; ++i)
    BOOST_CHECK_EQUAL(testSet.getDoubleProperty(testDouble_2_ro, i),
                      tab2Double[i]);

  BOOST_CHECK_THROW(testSet.getStringProperty("unexisting_properties"),
                    ofx::OfxhException);
