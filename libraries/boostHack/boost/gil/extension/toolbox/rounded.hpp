...
template <typename view_t> struct rounded {
...
#define ___ 0
    ...
    static unsigned char buffer3[] = {
      ___, ___, ___, ___, ___, ___, ___, ___, ___, ___, 255, ___, ___, ___,
      ___, ___, ___, ___, ___, ___, 255, 255, ___, ___, ___, ___, ___, ___,
      ___, ___, ___, 255, 255, ___, ___, ___, ___, ___, ___, ___, ___, 255,
      255, 255, ___, ___, ___, ___, ___, ___, ___, ___, 255, 255, 255, ___,
      ___, ___, ___, ___, ___, ___, 255, 255, 255, 255, ___, ___, ___, ___,
      ___, ___, 255, 255, 255, 255, 255, ___, ___, ___, ___, ___, 255, 255,
      255, 255, 255, 255, ___, ___, ___, ___, 255, 255, 255, 255, 255, 255,
      255, ___, ___, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
    ...
    width = 11;
    height = 11;
    gray8c_view_t grayview = interleaved_view(
        width, height, (gray8_pixel_t *)buffer3, sizeof(unsigned char) * width);
    ...
    copy<alpha24_blend>(backcolor, grayview,
                        subimage_view(view, view.width() - width,
                                      view.height() - height, width, height));
    copy<alpha24_blend>(
        backcolor, rotated90ccw_view(grayview),
        subimage_view(view, view.width() - width, 0, width, height));
    copy<alpha24_blend>(
        backcolor, rotated90cw_view(grayview),
        subimage_view(view, 0, view.height() - height, width, height));

    width = 15;
    height = 15;
    grayview = interleaved_view(width, height, (gray8_pixel_t *)buffer2,
    ...
    copy<alpha24_blend>(bordercolor, grayview,
                        subimage_view(view, view.width() - width,
                                      view.height() - height, width, height));
    copy<alpha24_blend>(
        bordercolor, rotated90ccw_view(grayview),
        subimage_view(view, view.width() - width, 0, width, height));
    copy<alpha24_blend>(
        bordercolor, rotated90cw_view(grayview),
        subimage_view(view, 0, view.height() - height, width, height));
  }
};
}
