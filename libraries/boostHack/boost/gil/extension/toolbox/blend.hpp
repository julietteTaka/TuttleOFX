...
template <typename blend_t, typename pixel_t, typename grayview_t,
          typename view_t>
inline void copy(pixel_t pixel, const grayview_t &grayview,
                 const view_t &view) {
...
inline void copy(const grayview_t &gray, const view_t &bottom,
                 const view_t &top) {
  using namespace boost::gil;
