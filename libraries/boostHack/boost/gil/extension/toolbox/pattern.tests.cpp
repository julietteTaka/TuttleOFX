...
struct test1 {
  void operator()() {
    ...
    unsigned char *buffer =
        new unsigned char[width * height * gimp_image.bytes_per_pixel];
    memset(buffer, 255, width * height * gimp_image.bytes_per_pixel);
    rgb8_view_t view = interleaved_view(width, height, (rgb8_pixel_t *)buffer,
                                        width * gimp_image.bytes_per_pixel);

    rgb8_view_t view2 =
        interleaved_view(gimp_image.width, gimp_image.height,
                         (rgb8_pixel_t *)gimp_image.pixel_data,
