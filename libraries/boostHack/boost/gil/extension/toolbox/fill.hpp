...
template <typename view_t> struct fill {
...
template <typename view_t> struct fill_horizontal {
  ...
  double maxvalue;
  funct_t funct;
  fill_horizontal(funct_t funct, double value1, double value2, double minvalue,
                  double maxvalue)
      : funct(funct), minvalue(minvalue), maxvalue(maxvalue), value1(value1),
        value2(value2) {}
