...
struct indexed_image_deref_fn
  ...
  indexed_image_deref_fn() : indexed_image_deref_fn_base() {}
...
struct indexed_image_deref_fn<
    ...
    typename boost::enable_if<
        boost::is_integral<typename IndicesLoc::value_type> >::
        type> : indexed_image_deref_fn_base<IndicesLoc, PaletteLoc> {
  indexed_image_deref_fn() : indexed_image_deref_fn_base() {}
...
public:
  ...
  typedef typename indexed_image_locator_type<
      indices_locator_t, palette_locator_t>::type locator_t;
