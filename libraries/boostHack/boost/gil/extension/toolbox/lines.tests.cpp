...
struct test1 {
  void operator()() {
    ...
    layer::uniform_horizontal_lines<rgb8_view_t> lines(
        rgb8_view_t::value_type(0, 0, 0), 10);
    lines(view);
...
struct test2 {
  void operator()() {
    ...
    layer::uniform_vertical_lines<rgb8_view_t> lines(
        rgb8_view_t::value_type(0, 0, 0), 10);
    lines(view);
...
struct test3 {
  void operator()() {
    ...
    layer::horizontal_line<rgb8_view_t> line(rgb8_view_t::value_type(0, 0, 0),
                                             30, 0, 100);
    line(view);
...
struct test4 {
  void operator()() {
    ...
    layer::vertical_lines<rgb8_view_t> line(rgb8_view_t::value_type(0, 0, 0),
                                            10, 20);
    line(view);
