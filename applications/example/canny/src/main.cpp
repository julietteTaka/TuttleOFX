...
int main(int argc, char **argv) {
  boost::shared_ptr<tuttle::common::formatters::Formatter> formatter(
  ...
  try {
    ...
    //		boost::gil::rgba32f_view_t imgResView =
    //imgRes->getGilView<boost::gil::rgba32f_view_t>();
    //		boost::gil::rgba8_view_t imgResView =
    //imgRes->getGilView<boost::gil::rgba8_view_t>();
    boost::gil::gray8_view_t imgResView =
        imgRes->getGilView<boost::gil::gray8_view_t>(
            tuttle::host::attribute::Image::eImageOrientationFromTopToBottom);
    boost::gil::png_write_view(
        "data/canny/manual_output.png",
