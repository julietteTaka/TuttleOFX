...
struct Dummy {
  ...
  void getCommandLineParameters(bpo::variables_map &node_vm,
                                const std::vector<std::string> &nodeArgs);
  void getParametersFromCommandLine(std::vector<std::string> &parameters,
                                    const std::vector<std::string> &nodeArgs);
  void getPathsFromCommandLine(std::vector<std::string> &paths,
                               const std::vector<std::string> &nodeArgs);
  void getExtensionsFromCommandLine(std::vector<std::string> &extensions,
                                    const std::vector<std::string> &nodeArgs);
