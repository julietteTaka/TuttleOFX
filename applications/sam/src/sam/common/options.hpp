...
#define SAM_EXAMPLE_TITLE_COUT(...)                                            \
  TUTTLE_COUT(std::endl << color->_yellow << "  " << __VA_ARGS__               \
                        << color->_std);
#define SAM_EXAMPLE_LINE_COUT(x, ...)                                          \
  TUTTLE_COUT(color->_green << "    " << std::setw(SAM_HELP_MARGING) << x      \
                            << __VA_ARGS__ << color->_std);
...
static const char *const kAllOptionMessage =
...
static const char *const kAttributesOptionMessage =
    "show all attributes: parameters+clips";

//-c, --commands
static const char *const kCommandsOptionLongName = "commands";
static const char *const kCommandsOptionString = "commands,c";
static const char *const kCommandsOptionMessage =
...
static const char *const kExpressionOptionMessage =
...
static const char *const kFilterOptionMessage =
    "filtering the output for research a plugin. ex: -f \"*blur,*tuttle*\"";
...
static const char *const kInputOptionMessage =
...
static const char *const kLongListingOptionMessage =
...
static const char *const kOffsetOptionMessage =
...
static const char *const kPathOptionMessage =
...
static const char *const kRangeOptionMessage =
    "processing range (used only if input is a sequence pattern)";

//-R, --recursive
static const char *const kRecursiveOptionLongName = "recursive";
static const char *const kRecursiveOptionString = "recursive,R";
static const char *const kRecursiveOptionMessage =
...
static const char *const kVerboseOptionMessage =
    "verbose level (trace=0, debug=1, info=2, warning=3, error=4, fatal=5)";
...
static const char *const kBinariesListOptionString =
    kBinariesListOptionLongName;
static const char *const kBinariesListOptionMessage =
    "show list of all available sam binaries";

//--brief
static const char *const kBriefOptionLongName = "brief";
static const char *const kBriefOptionString = kBriefOptionLongName;
static const char *const kBriefOptionMessage =
...
static const char *const kClipsOptionMessage =
...
static const char *const kCommandsListOptionString =
    kCommandsListOptionLongName;
static const char *const kCommandsListOptionMessage =
    "show list of all available sam commands";

//--continue-on-error
static const char *const kContinueOnErrorOptionLongName = "continue-on-error";
static const char *const kContinueOnErrorOptionString =
    kContinueOnErrorOptionLongName;
...
static const char *const kDisableProcessOptionString =
    kDisableProcessOptionLongName;
static const char *const kDisableProcessOptionMessage =
...
static const char *const kForceIdentityNodesProcessOptionLongName =
    "force-identity-nodes-process";
static const char *const kForceIdentityNodesProcessOptionString =
    kForceIdentityNodesProcessOptionLongName;
static const char *const kForceIdentityNodesProcessOptionMessage =
    "force identity nodes process (debug option for plugin developers only)";
...
//--first-image //TODO in sam-info and sam-ls, replace first-image and
//last-image by intput/output-first/last
...
static const char *const kFullDisplayOptionMessage =
    "display everything =directories, files, sequences";
...
static const char *const kFullRMPathOptionMessage =
    "remove everything =directories, files, sequences";

//--generator-args
static const char *const kGeneratorArgsOptionLongName = "generator-args";
static const char *const kGeneratorArgsOptionString =
    kGeneratorArgsOptionLongName;
static const char *const kGeneratorArgsOptionMessage =
    "properties of generator plugin";
...
static const char *const kInputFirstOptionMessage =
    "specify the first input image in order to select a sub-range of the input "
    "sequence";
...
static const char *const kInputLastOptionMessage =
    "specify the last input image in order to select a sub-range of the input "
    "sequence";

//--last-image //TODO in sam-info and sam-ls, replace first-image and last-image
//by intput/output-first/last
...
static const char *const kNodesListOptionMessage =
    "show list of all available nodes (formatted for scripting)";
...
static const char *const kOutputFirstOptionMessage =
    "specify the first output image, in order to select a sub-range of the "
    "output sequence";
...
static const char *const kOutputLastOptionMessage =
    "specify the last output image, in order to select a sub-range of the "
    "output sequence";
...
static const char *const kParametersOptionMessage =
    "list parameters of the OpenFX plugin";

//--parameters-redux-list
static const char *const kParametersReduxOptionLongName =
    "parameters-redux-list";
static const char *const kParametersReduxOptionString =
    kParametersReduxOptionLongName;
static const char *const kParametersReduxOptionMessage =
    "list parameters of the OpenFX plugin (redux informations)";

//--param-default
static const char *const kParamDefaultOptionLongName = "param-default";
static const char *const kParamDefaultOptionString =
    kParamDefaultOptionLongName;
...
static const char *const kParamGroupOptionMessage =
    "group of the OpenFX plugin";
...
static const char *const kParamInfosOptionMessage =
    "display parameter informations";

//--param-possible-values
static const char *const kParamPossibleValuesOptionLongName =
    "param-possible-values";
static const char *const kParamPossibleValuesOptionString =
    kParamPossibleValuesOptionLongName;
static const char *const kParamPossibleValuesOptionMessage =
...
static const char *const kPropertiesOptionMessage =
...
static const char *const kPluginsOptionMessage =
    "list of associated plugins for this dummy node";

//--reader
static const char *const kReaderOptionLongName = "reader";
static const char *const kReaderOptionString = kReaderOptionLongName;
static const char *const kReaderOptionMessage =
    "specify reader node with identifier \"tuttle.XXXreader\"";

//--relative-path
static const char *const kRelativePathOptionLongName = "relative-path";
static const char *const kRelativePathOptionString =
    kRelativePathOptionLongName;
static const char *const kRelativePathOptionMessage =
    "display the relative path of each object";

//--stop-on-missing-file
static const char *const kStopOnMissingFileOptionLongName =
    "stop-on-missing-file";
static const char *const kStopOnMissingFileOptionString =
    kStopOnMissingFileOptionLongName;
static const char *const kStopOnMissingFileOptionMessage =
    "stop on missing file";
...
static const char *const kScriptOptionMessage = "format the output such as it "
                                                "could be dump in a file and "
                                                "be used as a script";
}
